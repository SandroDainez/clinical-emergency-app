import type { GuidedDiscoveryContract } from "../lib/guided-discovery-contract";

export const GUIDED_DISCOVERY_CONTRACTS: readonly GuidedDiscoveryContract[] = [
  {
  ...
  },
  {
    ...
    steps: [
      {
        id: "decompor-instabilidade",
        prompt: "Quais sinais objetivos de instabilidade estão presentes?",
        obtainBy: "Coletar os critérios observáveis já definidos no nó guiado tqi_dados.",
      },
    ],
  ...
  },
  {
    ...
    steps: [
      {
        id: "decompor-hipoperfusao",
        prompt: "Quais sinais objetivos de hipoperfusão estão presentes?",
        obtainBy: "Coletar os achados observáveis já definidos no nó choque_dados.",
      },
    ],
  ...
  },
  {
    ...
    steps: [
      {
        id: "decompor-risco-hemodinamico",
        prompt: "Quais critérios objetivos de instabilidade estão presentes?",
        obtainBy: "Usar o nó tep_instab_dados para decompor pressão, perfusão e demais achados observáveis.",
      },
    ],
...
export function guidedDiscoveryFor(
  protocolId: string,
  decisionNodeId: string
): GuidedDiscoveryContract | undefined {
  return GUIDED_DISCOVERY_CONTRACTS.find(

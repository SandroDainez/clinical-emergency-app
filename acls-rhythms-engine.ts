/**
 * Engine mínimo para o módulo "Ritmos no ACLS".
...
const PROTOCOL_ID = "ritmos_acls";

const STATIC_STATE: ProtocolState = {
  type: "action",
  text: "Referência de ritmos no ACLS",
};
...
function getEncounterSummary(): EncounterSummary {
  ...
  return {
    ...
    currentStateId: "ritmos_acls_inicio",
    currentStateText: "Referência de ritmos no ACLS",
    shockCount: 0,
...
function getEncounterSummaryText(): string {
  return "Módulo de referência estática — Ritmos no ACLS";
}

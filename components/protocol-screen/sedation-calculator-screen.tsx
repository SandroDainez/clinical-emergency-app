...
const s = StyleSheet.create({
  ...
  input: { flex: 1.5, borderWidth: 1.5, borderColor: "#2a2e35", borderRadius: 10, padding: 10, fontSize: 16, fontWeight: "700", color: "#f1f5f9", backgroundColor: "#1c1f24" },
  ...
  modeChip: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10, backgroundColor: "#1c1f24", borderWidth: 1.5, borderColor: "#2a2e35" },
  ...
  solChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, backgroundColor: "#1c1f24", borderWidth: 1.5, borderColor: "#2a2e35", maxWidth: 230 },
  ...
  userDilApply: { flex: 1, backgroundColor: "#1c1f24", borderRadius: 10, padding: 10, borderWidth: 1.5, borderColor: "#c4b5fd" },
  ...
  acurasysBtn: { backgroundColor: "#1c1f24", borderRadius: 10, borderWidth: 1.5, borderColor: "#facc15", padding: 12, alignItems: "center" },
  ...
  rangeBox: { borderWidth: 1.5, borderRadius: 10, padding: 10, backgroundColor: "#1c1f24" },
  ...
  alertWarn: { backgroundColor: "#1c1f24", borderColor: "#f59e0b" },
  alertTxt: { fontSize: 12, fontWeight: "600", color: "#f1f5f9", lineHeight: 18 },

  collapsible: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#1c1f24", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 13, borderWidth: 1, borderColor: "#2a2e35" },
  collapseTitle: { fontSize: 13, fontWeight: "700", color: "#f1f5f9" },
  collapseChev: { fontSize: 12, color: "#94a3b8" },
  collapseBody: { backgroundColor: "#1c1f24", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, gap: 6, marginTop: -6, borderWidth: 1, borderColor: "#2a2e35" },

...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: "#0f172a", borderRadius: 14, padding: 14, gap: 10, borderWidth: 1, borderColor: "#1e293b" },
  ...
  input: { flex: 1.5, borderWidth: 1.5, borderColor: "#334155", borderRadius: 10, padding: 10, fontSize: 16, fontWeight: "700", color: "#f1f5f9", backgroundColor: "#0f172a" },
  ...
  modeChip: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10, backgroundColor: "#1e293b", borderWidth: 1.5, borderColor: "#334155" },
  modeChipActive: { backgroundColor: "rgba(99,102,241,0.2)", borderColor: "#818cf8" },
  modeChipTxt: { fontSize: 12, fontWeight: "700", color: "#94a3b8" },
  modeChipTxtActive: { color: "#c7d2fe" },

  dilSectionLabel: { fontSize: 10, fontWeight: "800", color: "#94a3b8", letterSpacing: 0.6, textTransform: "uppercase", marginTop: 2 },
  userDilEmpty: { fontSize: 11, color: "#94a3b8", fontStyle: "italic", paddingVertical: 4 },
  saveDilBtnDisabled: { opacity: 0.4 },
  solRow: { gap: 8, paddingVertical: 2 },
  solChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, backgroundColor: "#1e293b", borderWidth: 1.5, borderColor: "#334155", maxWidth: 230 },
  ...
  userDilApply: { flex: 1, backgroundColor: "#1e293b", borderRadius: 10, padding: 10, borderWidth: 1.5, borderColor: "#c4b5fd" },
  ...
  acurasysBtn: { backgroundColor: "#1e293b", borderRadius: 10, borderWidth: 1.5, borderColor: "#facc15", padding: 12, alignItems: "center" },
  ...
  rangeBox: { borderWidth: 1.5, borderRadius: 10, padding: 10, backgroundColor: "#0f172a" },
  rangeLabel: { fontSize: 13, fontWeight: "800" },
  rangeIndic: { fontSize: 11, color: "#94a3b8", marginTop: 2 },
  ...
  alertDanger: { backgroundColor: "#3b0a0a", borderColor: "#f87171" },
  alertWarn: { backgroundColor: "#1e293b", borderColor: "#f59e0b" },
  alertTxt: { fontSize: 12, fontWeight: "600", color: "#f1f5f9", lineHeight: 18 },

  collapsible: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#0f172a", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 13, borderWidth: 1, borderColor: "#1e293b" },
  collapseTitle: { fontSize: 13, fontWeight: "700", color: "#f1f5f9" },
  collapseChev: { fontSize: 12, color: "#94a3b8" },
  collapseBody: { backgroundColor: "#0f172a", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, gap: 6, marginTop: -6, borderWidth: 1, borderColor: "#1e293b" },
  refLine: { fontSize: 12.5, color: "#94a3b8", lineHeight: 19 },

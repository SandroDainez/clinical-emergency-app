...
const styles = StyleSheet.create({
  ...
  advanceButtonDisabled: { backgroundColor: "#262a32", borderColor: "#3a404a", shadowOpacity: 0, elevation: 0 },
  ...
  inputField: { gap: 8, borderTopWidth: 1, borderTopColor: "#3a404a", paddingTop: 12 },
  ...
  presetChipOther: { borderStyle: "dashed", borderColor: "#3a404a" },
  ...
  targetCardPressed: { backgroundColor: "#262a32", borderColor: "#4d9aff" },

...
const styles = StyleSheet.create({
  ...
  sideName: { fontSize: 9, fontWeight: "700", color: "#94a3b8", textAlign: "center", marginTop: 5, lineHeight: 12 },
  ...
  fieldSectionLabel: { fontSize: 10, fontWeight: "800", color: "#94a3b8", letterSpacing: 1, marginTop: 2 },
  clinicalSummaryCard: {
    borderRadius: 18,
    borderWidth: 1,
    borderColor: "#3a404a",

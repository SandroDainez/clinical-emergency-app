...
const s = StyleSheet.create({
  ...
  referralCard:     { backgroundColor: "#0f172a", borderRadius: 14, padding: 14, gap: 4, borderWidth: 1, borderColor: "#334155" },
  ...
  input:            { flex: 1.5, borderWidth: 1.5, borderColor: "#334155", borderRadius: 10, padding: 10,
                      fontSize: 16, fontWeight: "700", color: "#f1f5f9", backgroundColor: "#0f172a" },
  ...
  solChipActive:    { backgroundColor: "rgba(14,116,144,0.15)", borderColor: "#0e7490" },
  solChipTxt:       { fontSize: 11, fontWeight: "600", color: "#94a3b8" },
  solChipTxtActive: { color: "#22d3ee", fontWeight: "800" },
  ...
  userDilApply:     { flex: 1, backgroundColor: "#1e293b", borderRadius: 10, padding: 10,
  ...
  saveDilBtn:       { backgroundColor: "#1e293b", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5, borderWidth: 1, borderColor: "#c4b5fd" },
  saveDilBtnTxt:    { fontSize: 11, fontWeight: "800", color: "#c4b5fd" },
  dilFields:        { flexDirection: "row", gap: 8 },
  dilField:         { flex: 1, gap: 4 },
  diluentSeg:       { flexDirection: "row", borderWidth: 1.5, borderColor: "#334155", borderRadius: 10, overflow: "hidden" },
  diluentOpt:       { flex: 1, paddingVertical: 10, alignItems: "center", backgroundColor: "#0f172a" },
  diluentOptActive: { backgroundColor: "#1e293b" },
  diluentOptTxt:    { fontSize: 13, fontWeight: "700", color: "#94a3b8" },
  diluentOptTxtActive:{ color: "#f1f5f9" },
  concGrid:         { flexDirection: "row", backgroundColor: "#0f172a", borderRadius: 10, borderWidth: 1, borderColor: "#334155", overflow: "hidden" },
  concCell:         { flex: 1, alignItems: "center", paddingVertical: 10, paddingHorizontal: 4 },
  concDivider:      { width: 1, backgroundColor: "#334155" },
  concKey:          { fontSize: 9, fontWeight: "700", color: "#22d3ee", letterSpacing: 0.3, textTransform: "uppercase", marginBottom: 2 },
  concVal:          { fontSize: 13, fontWeight: "800", color: "#22d3ee", textAlign: "center" },
  concValHighlight: { color: "#f1f5f9", fontSize: 13 },

  // Calculator
  calcWeightRow:       { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "#0f172a", borderRadius: 10, borderWidth: 1, borderColor: "#334155", paddingHorizontal: 12, paddingVertical: 8 },
  calcWeightLabel:     { flex: 1, fontSize: 12, fontWeight: "600", color: "#94a3b8" },
  calcWeightLabelWarn: { color: "#d97706", fontWeight: "700" },
  calcWeightInput:     { width: 72, borderWidth: 1.5, borderColor: "#334155", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, fontSize: 15, fontWeight: "700", color: "#f1f5f9", backgroundColor: "#1e293b", textAlign: "right" },
  calcWeightInputWarn: { borderColor: "#f59e0b", backgroundColor: "#1e293b" },
  calcWeightUnit:      { fontSize: 12, fontWeight: "600", color: "#94a3b8", width: 22 },
  calcMissingWeight:   { backgroundColor: "#1e293b", borderRadius: 8, borderWidth: 1, borderColor: "#fcd34d", padding: 10 },
  ...
  calcInputRow:     { flexDirection: "row", alignItems: "center", borderWidth: 2, borderColor: "#334155", borderRadius: 12, overflow: "hidden", backgroundColor: "#0f172a" },
  calcInputRowActive:{ borderColor: "#0e7490", backgroundColor: "rgba(14,116,144,0.15)" },
  ...
  alertWarn:        { backgroundColor: "#1e293b", borderRadius: 10, padding: 12, borderWidth: 1.5, borderColor: "#f59e0b" },
  alertInfo:        { backgroundColor: "#0f172a", borderRadius: 10, padding: 12, borderWidth: 1.5, borderColor: "#3b82f6" },
  ...
  collapsible:      { flexDirection: "row", alignItems: "center", justifyContent: "space-between",
                      backgroundColor: "#0f172a", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14,
                      shadowColor: "#000", shadowOpacity: 0.2, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  collapseTitle:    { fontSize: 13, fontWeight: "700", color: "#f1f5f9" },
  collapseChev:     { fontSize: 12, color: "#94a3b8" },
  collapseBody:     { backgroundColor: "#0f172a", borderRadius: 12, paddingHorizontal: 16, paddingTop: 4, paddingBottom: 16, gap: 10, marginTop: -6 },
  refRow:           { gap: 2 },
  ...
  // Associations
  assocCard:        { backgroundColor: "#1e293b", borderRadius: 10, padding: 12, gap: 2, borderWidth: 1, borderColor: "#334155" },
  assocWarn:        { backgroundColor: "#1e293b", borderColor: "#fbbf24" },
  ...
  modalCard:        { backgroundColor: "#0f172a", borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, gap: 14 },
  modalTitle:       { fontSize: 18, fontWeight: "800", color: "#f1f5f9" },
  modalSub:         { fontSize: 12, color: "#64748b" },
  modalInput:       { borderWidth: 1.5, borderColor: "#334155", borderRadius: 12, padding: 14, fontSize: 15, color: "#f1f5f9" },
  modalBtns:        { flexDirection: "row", gap: 10 },
  modalCancel:      { flex: 1, padding: 14, borderRadius: 12, alignItems: "center", backgroundColor: "#1e293b" },
  modalCancelTxt:   { fontWeight: "700", color: "#94a3b8" },
  modalSave:        { flex: 1, padding: 14, borderRadius: 12, alignItems: "center", backgroundColor: "#0e7490" },

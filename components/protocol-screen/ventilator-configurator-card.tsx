...
const s = StyleSheet.create({
  ...
  chip: { minWidth: 46, borderRadius: 12, backgroundColor: "#262a32", borderWidth: 1.5, borderColor: "#3a404a", paddingHorizontal: 12, paddingVertical: 8, alignItems: "center" },
  chipActive: { backgroundColor: "#1e6fd9", borderColor: "#4d9aff" },
  chipTxt: { fontSize: 13.5, fontWeight: "700", color: "#cbd5e1" },
  chipTxtActive: { color: "#ffffff" },
  customInput: { minWidth: 64, minHeight: 38, borderRadius: 12, backgroundColor: "#1a1d23", borderWidth: 1, borderColor: "#3a404a", paddingHorizontal: 12, color: "#f1f5f9", fontSize: 14 },
  ...
  cell: { flexGrow: 1, flexBasis: "47%", backgroundColor: "#262a32", borderRadius: 12, borderWidth: 1, borderColor: "#3a404a", padding: 10, gap: 2 },
  ...
  placeholder: { marginTop: 8, padding: 12, borderRadius: 12, backgroundColor: "#262a32", borderWidth: 1, borderColor: "#3a404a" },

...
const sh = StyleSheet.create({
  ...
  unit:       { fontSize: 12, color: "#64748b", marginTop: 2, fontWeight: "700" },
  ...
  closeTxt:   { fontSize: 13, color: "#64748b", fontWeight: "800" },
  searchWrap: {
  ...
  rowSuggested:  { backgroundColor: "#451a03" },
  rowTextWrap: { flex: 1, gap: 2 },
  rowLabel:      { fontSize: 15, lineHeight: 20, color: "#e2e8f0", fontWeight: "700" },
  rowLabelActive:{ color: "#15803d", fontWeight: "800" },
  rowLabelSuggested: { color: "#854d0e", fontWeight: "800" },
  rowDetail: { fontSize: 12, lineHeight: 17, color: "#64748b", fontWeight: "600" },
  ...
  gcsTitle: { fontSize: 15, fontWeight: "800", color: "#f1f5f9" },
  gcsHint: { fontSize: 12, lineHeight: 18, color: "#64748b", fontWeight: "600" },
  gcsSection: { gap: 8 },
  gcsSectionTitle: { fontSize: 12, fontWeight: "800", color: "#94a3b8", textTransform: "uppercase" },
  gcsOption: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  gcsOptionText: { flex: 1, fontSize: 13, lineHeight: 18, color: "#94a3b8" },
  gcsOptionTextActive: { color: "#22d3ee", fontWeight: "600" },
  gcsFooter: {
    flexDirection: "row",
  ...
  gcsTotalLabel: { fontSize: 11, fontWeight: "800", color: "#64748b", textTransform: "uppercase" },
  gcsTotalValue: { fontSize: 28, fontWeight: "800", color: "#f1f5f9" },
  gcsApplyBtn: {
  ...
  emptyTitle: { fontSize: 13, fontWeight: "700", color: "#94a3b8" },
  emptyText: { fontSize: 12, color: "#64748b", lineHeight: 17, fontWeight: "600" },
  suggestionBanner: {
    flexDirection: "row", alignItems: "center",
  ...
  summaryLbl: { fontSize: 11, fontWeight: "800", color: "#64748b" },
...
const sb = StyleSheet.create({
  ...
  tokenTxt:  { fontSize: 11, fontWeight: "600", color: "#4ade80", flexShrink: 1 },
  tokenMore: {
    backgroundColor: "#052e16", borderRadius: 6,
    paddingHorizontal: 7, paddingVertical: 2,
  },
  tokenMoreTxt: { fontSize: 11, fontWeight: "700", color: "#4ade80" },
});
...
const f = StyleSheet.create({
  ...
  unitTxt:  { fontSize: 10, color: "#64748b", fontWeight: "800" },
  unitTxtOn:{ color: "#ffffff" },
  hint: { fontSize: 11, color: "#22d3ee", lineHeight: 16, fontStyle: "italic", fontWeight: "600", marginTop: 4, paddingHorizontal: 4, paddingVertical: 3, borderRadius: 6, backgroundColor: "#0d1728" },
  suggestionRow: {
    flexDirection: "row", alignItems: "center",
    backgroundColor: "#451a03",
...
const s = StyleSheet.create({
  card: {
    ...
    backgroundColor: "#1e293b", borderRadius: 16, overflow: "hidden" as const,
    borderWidth: 1, borderColor: "#334155",
  ...
  dashItem: {
    backgroundColor: "#0d1728", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4,
    minWidth: 60, flexGrow: 1, alignItems: "center", borderWidth: 1, borderColor: "#164e63",
  },
  dashItemWide: {
    width: "100%",
  },
  ...
  dashVal: { fontSize: 12, fontWeight: "900", color: "#22d3ee" },
  dashValPrimary: { fontSize: 13 },
  dashValCompact: { fontSize: 11, lineHeight: 16 },
  dashLbl: { fontSize: 10, color: "#64748b", marginTop: 1, textAlign: "center", fontWeight: "800" },
  alertsWrap: { paddingHorizontal: 10, paddingBottom: 8, gap: 6 },
  alertBanner: {
    flexDirection: "row", alignItems: "flex-start", gap: 8,
    borderRadius: 10, padding: 10, borderWidth: 1.5,
    backgroundColor: "#450a0a", borderColor: "#991b1b",
  },
  alertOrange: { backgroundColor: "#431407", borderColor: "#fb923c" },
  alertRed:    { backgroundColor: "#450a0a", borderColor: "#f87171" },
  ...
  cell: { width: "47%" },
  cellFull: { width: "100%" },
  seg: { flexDirection: "row", borderRadius: 8, borderWidth: 1, borderColor: "#334155", overflow: "hidden" },
  segItem: { flex: 1, minHeight: 42, justifyContent: "center", alignItems: "center", backgroundColor: "#0f172a", borderRightWidth: 1, borderRightColor: "#334155" },
  ...
  segText:    { fontSize: 12, fontWeight: "800", color: "#94a3b8" },
  segTextActive: { color: "#ffffff" },
  segTxtDone:    { color: "#065f46" },
  bundleRow: { gap: 5 },
  bundleLbl: { fontSize: 13, fontWeight: "800", color: "#f1f5f9" },
  calcCard: { backgroundColor: "#052e16", borderRadius: 12, padding: 12, gap: 3, borderWidth: 1.5, borderColor: "#166534" },
  calcTitle: { fontSize: 12, fontWeight: "800", color: "#4ade80" },
  calcValue: { fontSize: 26, fontWeight: "800", color: "#4ade80" },
  calcHint:  { fontSize: 11, color: "#4ade80", lineHeight: 16, fontWeight: "700" },
  recCard:  { backgroundColor: "#0d1728", borderRadius: 10, padding: 12, gap: 4, borderWidth: 1, borderColor: "#164e63" },
  recWarn:  { backgroundColor: "#431407", borderColor: "#fed7aa" },
  recDanger: { backgroundColor: "#450a0a", borderColor: "#fecaca" },
  recTitle: { fontSize: 13, fontWeight: "900", color: "#67e8f9" },
  recLine:  { fontSize: 13, color: "#94a3b8", lineHeight: 19, fontWeight: "600" },

  // ── Prescription-style ATB card (inline in Antimicrobiano section) ────────
  rxCard:    { backgroundColor: "#052e16", borderRadius: 12, padding: 14, gap: 4, borderWidth: 2, borderColor: "#16a34a", marginBottom: 8 },
  rxWarn:    { backgroundColor: "#451a03", borderColor: "#f59e0b" },
  rxDanger:  { backgroundColor: "#450a0a", borderColor: "#ef4444" },
  rxTitle:   { fontWeight: "900", fontSize: 15, color: "#4ade80", marginBottom: 2 },
  rxLine:    { fontSize: 13, color: "#f1f5f9", lineHeight: 20, fontWeight: "600" },
  rxDrug:    { fontWeight: "700", color: "#4ade80", fontSize: 13 },
  ...
  pamCardTitle: { fontSize: 15, fontWeight: "700", color: "#f1f5f9", marginBottom: 10 },
  ...
  pamCardPa: { fontSize: 16, fontWeight: "600", color: "#94a3b8", lineHeight: 22 },
  pamCardPamVal: { fontSize: 22, fontWeight: "700", color: "#f1f5f9", lineHeight: 28 },
  ...
  actBtnTxtSecondary: { color: "#e2e8f0", fontSize: 14, fontWeight: "600" },
});

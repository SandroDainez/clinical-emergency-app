...
const s = StyleSheet.create({
  ...
  input: { width: 110, borderWidth: 1.5, borderColor: "#334155", borderRadius: 10, padding: 10, fontSize: 16, fontWeight: "700", color: "#f1f5f9", backgroundColor: "#0f172a", textAlign: "right" },
  toggleRow: { flexDirection: "row", gap: 7, flexWrap: "wrap" },
  toggleChip: { paddingHorizontal: 14, paddingVertical: 9, borderRadius: 10, backgroundColor: "#1e293b", borderWidth: 1.5, borderColor: "#334155" },
  ...
  alertBox: { backgroundColor: "#1e293b", borderRadius: 12, borderWidth: 1.5, borderColor: "#f59e0b", padding: 12, gap: 4 },
  alertTxt: { fontSize: 12, fontWeight: "600", color: "#fcd34d", lineHeight: 18 },

  resultCard: { backgroundColor: "#0f172a", borderRadius: 16, borderWidth: 1.5, borderColor: "#334155", padding: 16, gap: 8 },
  ...
  metricRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 8, borderTopWidth: 1, borderTopColor: "#1e293b", paddingTop: 8 },
  ...
  scoreVar: { gap: 6, borderTopWidth: 1, borderTopColor: "#1e293b", paddingTop: 10 },
  scoreVarLabel: { fontSize: 13, fontWeight: "700", color: "#e2e8f0" },
  optWrap: { flexDirection: "row", flexWrap: "wrap", gap: 7 },
  optChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, backgroundColor: "#1e293b", borderWidth: 1.5, borderColor: "#334155" },
  ...
  tableRow: { flexDirection: "row", gap: 10, borderTopWidth: 1, borderTopColor: "#1e293b", paddingTop: 8 },
  tableK: { width: 92, fontSize: 12, fontWeight: "800", color: "#7dd3fc" },
  tableV: { flex: 1, fontSize: 12.5, color: "#cbd5e1", lineHeight: 18 },

  noteBox: { backgroundColor: "#0f172a", borderRadius: 12, borderWidth: 1, borderColor: "#1e293b", padding: 12 },
  noteTxt: { fontSize: 12.5, color: "#94a3b8", lineHeight: 18 },

  placeholder: { backgroundColor: "#0f172a", borderRadius: 12, borderWidth: 1, borderColor: "#1e293b", padding: 16 },
  placeholderTxt: { fontSize: 13, color: "#94a3b8" },

  reference: { fontSize: 11, color: "#475569", fontStyle: "italic", lineHeight: 16 },
});

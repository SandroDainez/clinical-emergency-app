...
const s = StyleSheet.create({
  ...
  toggleChip: { paddingHorizontal: 14, paddingVertical: 9, borderRadius: 10, backgroundColor: "#383e4a", borderWidth: 1.5, borderColor: "#565e6c" },
  ...
  tableRow: { flexDirection: "row", gap: 10, borderTopWidth: 1, borderTopColor: "#565e6c", paddingTop: 8 },

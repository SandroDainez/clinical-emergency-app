      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.hero}>
          <View style={s.heroBadge}>
            <Text style={s.heroBadgeText}>CAD e estado hiperosmolar</Text>
          </View>
          <Text style={s.title}>Cetoacidose vs hiperosmolar</Text>
          <Text style={s.subtitle}>
            Roteiro completo de emergência em etapas — classificação automática,
            condutas por quadro e alertas de segurança.
          </Text>
        </View>
        ...
        <View style={s.card}>
          <View style={s.featureList}>
            {[
              { icon: "🔀", text: "Diferencia CAD (acidose + cetose) de EHH (hiperglicemia + hiperosm)" },
              { icon: "📊", text: "PAM, osmolaridade estimada e gap aniônico no painel" },
              { icon: "🚑", text: "Primeiros minutos: SpO₂, acesso venoso, ECG e registro" },
              { icon: "📋", text: "Tratamento: volume, insulina, potássio e alertas (K⁺ antes de insulina)" },
            ].map((f) => (
          ...
          <Text style={s.disclaimer}>
            Referência alinhada a diretrizes tipo ADA; ajustar ao protocolo
            institucional e ao paciente.
          </Text>
          ...
          <Pressable
            ...
            <Text style={s.buttonHint}>Abrir roteiro CAD / EHH</Text>
          </Pressable>
        </View>

/**
 * Engine mínimo para o módulo "Causas Reversíveis (Hs e Ts)".
...
const PROTOCOL_ID = "causas_reversiveis_acls";

const STATIC_STATE: ProtocolState = {
  type: "action",
  text: "Referência — Causas Reversíveis (Hs e Ts)",
};
...
function getCurrentStateId(): string { return "causas_reversiveis_acls_inicio"; }
...
function getEncounterSummary(): EncounterSummary {
  ...
  return {
    ...
    currentStateId: "causas_reversiveis_acls_inicio",
    currentStateText: "Referência — Causas Reversíveis (Hs e Ts)",
    shockCount: 0,
...
function getEncounterSummaryText(): string { return "Módulo de referência estática — Causas Reversíveis (Hs e Ts)"; }

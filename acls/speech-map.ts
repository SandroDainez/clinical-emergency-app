...
const ACLS_AUDIO_EVENT_MAP = {
  ...
  start_cpr: "Iniciar RCP agora. Cem a cento e vinte compressões por minuto.",
  resume_cpr: "Retomar RCP imediatamente. Dois minutos. Não verificar pulso.",
  start_cpr_nonshockable: "Não chocável. Iniciar RCP agora. Epinefrina 1 mg IV ou IO.",

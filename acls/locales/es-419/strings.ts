...
export const ES_STRINGS: Record<string, string> = {
  ...
  "Faça agora": "Hágalo ahora",
  "Continuar": "Continuar",
  "Confirmar e continuar": "Confirmar y continuar",
  "⚠ Instabilidade identificada — toque para reavaliar": "⚠ Inestabilidad identificada — toque para reevaluar",
  "✓ Estabilidade avaliada — toque para reavaliar": "✓ Estabilidad evaluada — toque para reevaluar",
  "Ver o restante da conduta": "Ver el resto de la conducta",

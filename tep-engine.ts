/**
 * Engine mínimo para o módulo "Tromboembolia Pulmonar (TEP)".
...
const PROTOCOL_ID = "tromboembolia_pulmonar";

const STATIC_STATE: ProtocolState = {
  type: "action",
  text: "Tromboembolia pulmonar",
};
...
function getEncounterSummary(): EncounterSummary {
  ...
  return {
    ...
    currentStateId: "tep_inicio",
    currentStateText: "Tromboembolia pulmonar",
    shockCount: 0,
...
function getEncounterSummaryText(): string {
  return "Módulo de fluxo — Tromboembolia Pulmonar";
}

...
function buildFields(a: Assessment): AuxiliaryPanel["fields"] {
  ...
  return [
    { id: "age", label: "Idade", value: a.age, keyboardType: "numeric", placeholder: "anos", section: "Identificação" },
    {
      id: "sex",
      label: "Sexo",
      value: a.sex,
    ...
    { id: "weightKg", label: "Peso (kg)", value: a.weightKg, keyboardType: "numeric", section: "Identificação" },
    {
      id: "comorbidities",
      ...
      helperText: "Toque para combinar",
      presets: [
    ...
    { id: "allergies", label: "Alergias", value: a.allergies, fullWidth: true, section: "Comorbidades e risco", placeholder: "NKDA ou descrever" },
    {
      id: "chiefComplaint",
      label: "Queixa / início",
      ...
      presetMode: "toggle_token",
      presets: [
        { label: "Dispneia súbita", value: "Dispneia súbita" },
        { label: "Ortopneia", value: "Ortopneia" },
        { label: "Expectoração rosada / espumosa", value: "Expectoração rosada / espumosa" },
        { label: "Dor torácica associada", value: "Dor torácica associada" },
      ],
    },
    { id: "symptomOnset", label: "Tempo de evolução", value: a.symptomOnset, section: "Apresentação", placeholder: "ex.: minutos / horas" },
    ...
    { id: "oxygenSaturation", label: "SpO₂ (%)", value: a.oxygenSaturation, keyboardType: "numeric", section: "Sinais vitais" },
    {
      id: "fio2Fraction",
      label: "FiO₂ (fração)",
    ...
    },
    {
      ...
      presets: [
        { label: "EAP cardiogênico provável", value: "EAP cardiogênico provável" },
        { label: "Sobrecarga volêmica", value: "Sobrecarga volêmica" },
        { label: "EAP em contexto de SCA (avaliar)", value: "EAP em contexto de SCA (avaliar)" },
    ...
    },
    {
      ...
      presets: [
        { label: "Posição sentada, pernas pendentes", value: "Posição sentada, pernas pendentes" },
        { label: "Oxigenoterapia / alto fluxo", value: "Oxigenoterapia / alto fluxo" },
        { label: "Nitrato (SL ou IV)", value: "Nitrato (SL ou IV)" },
        { label: "Furosemida IV", value: "Furosemida IV" },
        { label: "Morfina IV (cautela)", value: "Morfina IV (cautela)" },
        { label: "VMNI (CPAP/BiPAP)", value: "VMNI (CPAP/BiPAP)" },
      ],
    },
    {
      id: "nivCpap",
    ...
    },
    {
      ...
      section: "Evolução e destino",
      presets: [
        { label: "UTI / coronariana", value: "UTI / coronariana" },
        { label: "Observação / intermediate care", value: "Observação / intermediate care" },
        { label: "Enfermaria (caso leve estável)", value: "Enfermaria (caso leve estável)" },
      ],
    },

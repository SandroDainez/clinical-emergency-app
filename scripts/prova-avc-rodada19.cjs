 ...
 * UNIVERSO: `avc/nucleo/{veredito-da-trombolise,portao-ivt,derivacoes-f}.ts`, `avc/conteudo/campos.ts`.
...
try {
  execFileSync("npx", ["tsc", "--module", "commonjs", "--target", "es2020", "--esModuleInterop",
    ...
    path.join(appDir, "avc", "nucleo", "portao-ivt.ts"), path.join(appDir, "avc", "conteudo", "campos.ts")],

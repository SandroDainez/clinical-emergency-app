...
replaceRequired(
  ...
  '  "Metas: PAS conforme idade e perfusão · SpO₂ ≥ 94% (PaO₂ 80–100 mmHg como alvo inicial) · PaCO₂ 35–40 mmHg na ausência de HIC · normotermia · glicemia 100–180 mg/dL · Na 135–145 mEq/L como alvo basal; evitar hiponatremia e não induzir hipernatremia profilática.";',
...
replaceRequired(
  ...
  '  "Metas mantidas: PIC < 22 mmHg; PPC 60–70 mmHg, individualizada pela autorregulação quando disponível; SpO₂ ≥ 94% e PaO₂ 80–100 mmHg como alvos iniciais; PaCO₂ 35–40 mmHg na ausência de HIC; pressão arterial suficiente para perfusão cerebral; normotermia; glicemia 100–180 mg/dL; Na 135–145 mEq/L como alvo basal.";',
  'ICU targets'
);
...
const entries = [
  ['Metas: PAS conforme idade e perfusão · SpO₂ ≥ 94% (PaO₂ 80–100 mmHg como alvo inicial) · PaCO₂ 35–40 mmHg na ausência de HIC · normotermia · glicemia 100–180 mg/dL · Na 135–145 mEq/L como alvo basal; evitar hiponatremia e não induzir hipernatremia profilática.', 'Metas: PAS según edad y perfusión · SpO₂ ≥ 94% (PaO₂ 80–100 mmHg como objetivo inicial) · PaCO₂ 35–40 mmHg en ausencia de HIC · normotermia · glucemia 100–180 mg/dL · Na 135–145 mEq/L como objetivo basal; evitar hiponatremia y no inducir hipernatremia profiláctica.'],
  ['Metas mantidas: PIC < 22 mmHg; PPC 60–70 mmHg, individualizada pela autorregulação quando disponível; SpO₂ ≥ 94% e PaO₂ 80–100 mmHg como alvos iniciais; PaCO₂ 35–40 mmHg na ausência de HIC; pressão arterial suficiente para perfusão cerebral; normotermia; glicemia 100–180 mg/dL; Na 135–145 mEq/L como alvo basal.', 'Metas mantenidas: PIC < 22 mmHg; PPC 60–70 mmHg, individualizada por la autorregulación cuando esté disponible; SpO₂ ≥ 94% y PaO₂ 80–100 mmHg como objetivos iniciales; PaCO₂ 35–40 mmHg en ausencia de HIC; presión arterial suficiente para la perfusión cerebral; normotermia; glucemia 100–180 mg/dL; Na 135–145 mEq/L como objetivo basal.'],
...
console.log('✅ TCE: alvos ACS 2024, TC seriada, antiagregação e sódio atualizados.');

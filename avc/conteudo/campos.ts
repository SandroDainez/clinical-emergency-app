...
import { ACAO_DE_TROMBOLISE, CAMPO_DO_HORARIO_CLINICO, CAMPO_DO_JULGAMENTO, CAMPOS_DA_DECISAO_MEDICA, DECISAO_DE_PROSSEGUIR } from "./superficie-f";
...
export function todosOsCampos(): readonly Campo[] {
  return [
    ...
    /** ⚠️ ARQ-APOIO-01 F1: os fatos que acompanham a decisão médica, na instância do julgamento. */
    ...CAMPOS_DA_DECISAO_MEDICA.map((c) => ({ ...c, casa: "reperfusao" as const })),
    /** AC-13 reaberto, item 3: o horário clínico da transição tem instância; fora do registro, seria gravado sem ela. */
    { ...CAMPO_DO_HORARIO_CLINICO, casa: "reperfusao" as const },
    /**

  ...
  },
  {
    ...
    causes: [
      ...
      },
      {
        ...
        interventionDetail:
          "Tricíclicos: bicarbonato 1–2 mEq/kg. Opioides: naloxona 0,4–2 mg IV se o opioide for desconhecido — fentanil e análogos podem exigir mais de 2 mg ou infusão; se a equipe deu o opioide, titular 0,1–0,2 mg. A meia-vida da naloxona é MENOR que a da maioria dos opioides: a depressão respiratória PODE VOLTAR depois de o paciente já ter acordado — vigiar por horas. Organofosforados: atropina em altas doses. Intoxicação grave: considerar ECMO. ⚠️ ANESTÉSICO LOCAL (LAST) — E ESTE VAI INLINE, ao contrário do resto: bloqueio, peridural, infiltração ou tópico em mucosa, com convulsão, arritmia ou colapso. EMULSÃO LIPÍDICA 20%, sem diluir, direto do frasco: ACIMA DE 70 kg, bolus de 100 mL em 2–3 min + 200–250 mL em 15–20 min; ABAIXO DE 70 kg, 1,5 mL/kg + 0,25 mL/kg/min. Repetir o bolus ou dobrar a infusão se não estabilizar; manter 10 min após estabilizar; teto de 12 mL/kg. ⚠️ PROPOFOL NÃO SUBSTITUI — o conteúdo lipídico é baixo demais e ele é cardiodepressor. ADRENALINA em dose MENOR que 1 mcg/kg (a dose padrão do ACLS piora o LAST); EVITAR vasopressina, bloqueador de canal de cálcio, betabloqueador e mais anestésico local. ACIONE A EQUIPE DE CIRCULAÇÃO EXTRACORPÓREA junto com o pedido de ajuda — montar leva tempo que não existe depois do colapso. → O resto da toxicologia é específico de cada agente, e listar alguns aqui criaria a mesma lista parcial que este módulo existe para evitar: abrir Intoxicações Exógenas.",
      },
    ],
  },
];

...
import { ES_ANTIMICROBIANOS } from "./modules/antimicrobianos";
import { ES_SEPSE } from "./modules/sepse";
import { ES_AVC } from "./modules/avc";
// ⚠️ Módulo AVC RECONSTRUÍDO (2026-08-28). Dicionário próprio, primeiro na cadeia
// para que o vocabulário novo vença o do módulo demolido, que segue no bundle
// servindo apenas ao histórico de traduções.
import { ES_AVC_MODULO } from "./modules/avc-modulo";
...
import { ES_OVACE_COCKPIT } from "./modules/ovace-cockpit";
import { ES_CONSENTIMENTO } from "./modules/consentimento";
import { ES_AVC_HEMORRAGICO } from "./modules/avc-hemorragico";
import { ES_AVC_ANTIHIPERTENSIVOS } from "./modules/avc-antihipertensivos";
import { ES_AVC_GLICEMIA } from "./modules/avc-glicemia";
import { ES_ROTULOS_QUE_ESCAPAVAM } from "./modules/rotulos-que-escapavam";
...
import { scaV2Es as ES_SCA_V2 } from "./modules/sca-v2";
import { escoresLimitesMovidosEs as ES_ESCORES_MOVIDOS } from "./modules/escores-limites-movidos";
import { avcImagemEs as ES_AVC_IMAGEM } from "./modules/avc-imagem";
import { avcSolicitacaoImagemEs as ES_AVC_SOLICITACAO_IMAGEM } from "./modules/avc-solicitacao-imagem";
import { avcPacienteFaseEs as ES_AVC_PACIENTE_FASE } from "./modules/avc-paciente-fase";
import { avcAbcdeEs as ES_AVC_ABCDE } from "./modules/avc-abcde";
...
import { injuriaRenalAgudaEs as ES_IRA } from "./modules/injuria-renal-aguda";
...
import { tcePenetranteEs as ES_TCE_PENETRANTE } from "./modules/tce-penetrante";
import { eletrolitosCampoEs as ES_ELETRO_CAMPO } from "./modules/eletrolitos-campo";
import { railModuloEs as ES_RAIL } from "./modules/rail-modulo";
import { naDuvidaEs as ES_NA_DUVIDA } from "./modules/na-duvida";
import { quandoNaoFechaEs as ES_NAO_FECHA } from "./modules/quando-nao-fecha";
import { viaAereaDominiosEs as ES_VIA_AEREA } from "./modules/via-aerea-dominios";
import { contraindicacaoTromboliseEs as ES_CI_TROMBO } from "./modules/contraindicacao-trombolise";
import { oclusaoGrandeVasoEs as ES_LVO } from "./modules/oclusao-grande-vaso";
...
import { ES_FRASES_MONTADAS } from "./modules/frases-montadas-em-runtime";

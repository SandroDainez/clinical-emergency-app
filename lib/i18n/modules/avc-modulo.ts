...
export const ES_AVC_MODULO: Record<string, string> = {
  ...
  "Estado da transferência": "Estado del traslado",
  "Cada toque registra o marco com o horário. Aceite só existe quando registrado.": "Cada toque registra el hito con la hora. La aceptación solo existe cuando se registra.",

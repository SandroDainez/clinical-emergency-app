...
export const ES_CALCULADORAS: Record<string, string> = {
  ...
  "Atenção à LATERALIDADE: na escala padrão 5a e 6a são o lado ESQUERDO e 5b e 6b o DIREITO — inverter isso troca o hemisfério ao passar o caso adiante. Itens não testáveis (amputação, fusão articular, intubação): use a opção UN, com justificativa; UN não entra na soma.": "Atención a la LATERALIDAD: en la escala estándar 5a y 6a son el lado IZQUIERDO y 5b y 6b el DERECHO — invertir esto cambia el hemisferio al pasar el caso adelante. Ítems no evaluables (amputación, fusión articular, intubación): use la opción UN, con justificación; UN no entra en la suma.",
  ...
  "GCS 8 — limiar clássico de proteção de via aérea": "GCS 8 — umbral clásico de protección de la vía aérea",
  "GCS ≤ 7 — grave": "GCS ≤ 7 — grave",
  "Intubado/traqueostomizado: registrar V como 'T'. GCS < 13 em TCE → TC de crânio urgente — abrir o módulo TCE, que estratifica a indicação e os alvos.": "Intubado/traqueostomizado: registrar V como 'T'. GCS < 13 en TCE → TC de cráneo urgente — abrir el módulo TCE, que estratifica la indicación y los objetivos.",
  "Não desperta a estímulo físico. Pode ser sedação profunda, bloqueio neuromuscular em curso ou lesão neurológica — a escala não distingue os três. Sob bloqueio, RASS −5 é o alvo correto e não indica excesso de sedativo. Abrir o módulo Sedoanalgesia.": "No despierta al estímulo físico. Puede ser sedación profunda, bloqueo neuromuscular en curso o lesión neurológica — la escala no distingue los tres. Bajo bloqueo, RASS −5 es el objetivo correcto y no indica exceso de sedante. Abrir el módulo Sedoanalgesia.",
  "ABSOLUTA, do paciente que está na frente. É a que os estudos de ajuste de dose usaram, e a que se leva para a bula.": "ABSOLUTA, del paciente que está delante. Es la que usaron los estudios de ajuste de dosis y la que se lleva al prospecto.",
  "ClCr (Cockcroft-Gault) — ABSOLUTA, é esta que ajusta dose": "ClCr (Cockcroft-Gault) — ABSOLUTA, es esta la que ajusta la dosis",
  "ClCr ABSOLUTO (mL/min) — não a TFG indexada": "ClCr ABSOLUTO (mL/min) — no la TFG indexada",
  "INDEXADA a uma superfície corporal padrão. Serve para ESTADIAR doença renal crônica (KDIGO) e comparar pacientes entre si.": "INDEXADA a una superficie corporal estándar. Sirve para ESTADIFICAR la enfermedad renal crónica (KDIGO) y comparar pacientes entre sí.",
  "Informar o clearance ABSOLUTO em mL/min (Cockcroft-Gault), não a TFG indexada em mL/min/1,73 m² (CKD-EPI). São medidas diferentes: a indexada corrige para uma superfície corporal padrão e serve para estadiar doença renal; a absoluta é a do paciente que está na frente, e é a que os estudos de ajuste de dose usaram. No obeso e no caquético as duas se separam bastante. A ferramenta Clearance/TFG desta mesma tela devolve as duas, rotuladas.": "Informar el clearance ABSOLUTO en mL/min (Cockcroft-Gault), no la TFG indexada en mL/min/1,73 m² (CKD-EPI). Son medidas diferentes: la indexada corrige a una superficie corporal estándar y sirve para estadificar la enfermedad renal; la absoluta es la del paciente que está delante, y es la que usaron los estudios de ajuste de dosis. En el obeso y en el caquéctico ambas se separan bastante. La herramienta Clearance/TFG de esta misma pantalla devuelve las dos, rotuladas.",
  "Limiar ≥ 2: Seymour CW et al. JAMA. 2016;315(8):762–774. Papel na triagem: Surviving Sepsis Campaign 2026.": "Umbral ≥ 2: Seymour CW et al. JAMA. 2016;315(8):762–774. Papel en el triaje: Surviving Sepsis Campaign 2026.",
  "Peso atual (só para Cockcroft-Gault)": "Peso actual (solo para Cockcroft-Gault)",
  "Quando divergem": "Cuándo divergen",
  "Quanto mais o paciente se afasta da superfície padrão, mais elas se separam — no obeso, no caquético e no muito baixo. Usar a indexada para ajustar dose é valor certo com MEDIDA errada, o mesmo mecanismo do ureia × BUN.": "Cuanto más se aleja el paciente de la superficie estándar, más se separan — en el obeso, en el caquéctico y en el de muy baja estatura. Usar la indexada para ajustar la dosis es valor correcto con MEDIDA equivocada, el mismo mecanismo de la urea × BUN.",
  "TFG (CKD-EPI 2021) — INDEXADA à superfície corporal": "TFG (CKD-EPI 2021) — INDEXADA a la superficie corporal",

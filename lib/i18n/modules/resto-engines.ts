...
export const ES_RESTO_ENGINES: Record<string, string> = {
  ...
  "1ª hora: SF 0,9% {sfLow}–{sfHigh} mL (15–20 mL/kg/h; ≈ 1–1,5 L), EM ALÍQUOTAS com reavaliação após cada uma — reduzir em ICC, DRC ou idoso. Em choque: 500 mL em 15–30 min, repetir até PAS ≥ 90 mmHg.":
    "1.ª hora: SF 0,9% {sfLow}–{sfHigh} mL (15–20 mL/kg/h; ≈ 1–1,5 L), EN ALÍCUOTAS con reevaluación tras cada una — reducir en ICC, ERC o adulto mayor. En choque: 500 mL en 15–30 min, repetir hasta PAS ≥ 90 mmHg.",
  "A meia-vida da naloxona é MENOR que a da maioria dos opioides — a depressão respiratória PODE VOLTAR depois de o paciente já ter acordado. Vigiar por horas, não por minutos.":
    "La vida media de la naloxona es MENOR que la de la mayoría de los opioides — la depresión respiratoria PUEDE VOLVER después de que el paciente ya despertó. Vigilar por horas, no por minutos.",
  "ACESSO VENOSO CALIBROSO (2): SF 0,9% ou Ringer Lactato 1.000–2.000 mL rápido no adulto (20 mL/kg na criança), EM ALÍQUOTAS de 500 mL, reavaliando perfusão e congestão após CADA uma — o volume é titulado, não prescrito de uma vez. Cardiopata, disfunção renal, idoso ou gestante: alíquotas de 250 mL e reavaliação mais frequente — repetir conforme a PA.":
    "ACCESO VENOSO GRUESO (2): SF 0,9% o Ringer Lactato 1.000–2.000 mL rápido en el adulto (20 mL/kg en el niño), EN ALÍCUOTAS de 500 mL, reevaluando perfusión y congestión tras CADA una — el volumen se titula, no se prescribe de una vez. Cardiópata, disfunción renal, adulto mayor o gestante: alícuotas de 250 mL y reevaluación más frecuente — repetir según la PA.",
  "ACESSO VENOSO: 2 acessos calibrosos. Cristaloide: SF 0,9% ou Ringer Lactato 1.000–2.000 mL rápido no adulto (20 mL/kg na criança), EM ALÍQUOTAS de 500 mL, reavaliando perfusão e congestão após CADA uma — o volume é titulado, não prescrito de uma vez. Cardiopata, disfunção renal, idoso ou gestante: alíquotas de 250 mL e reavaliação mais frequente.":
    "ACCESO VENOSO: 2 accesos gruesos. Cristaloide: SF 0,9% o Ringer Lactato 1.000–2.000 mL rápido en el adulto (20 mL/kg en el niño), EN ALÍCUOTAS de 500 mL, reevaluando perfusión y congestión tras CADA una — el volumen se titula, no se prescribe de una vez. Cardiópata, disfunción renal, adulto mayor o gestante: alícuotas de 250 mL y reevaluación más frecuente.",
  "CHOQUE ANAFILÁTICO — adrenalina IM imediata, dois acessos, cristaloide 1.000–2.000 mL rápido no adulto (20 mL/kg na criança), EM ALÍQUOTAS de 500 mL, reavaliando perfusão e congestão após CADA uma — o volume é titulado, não prescrito de uma vez. Cardiopata, disfunção renal, idoso ou gestante: alíquotas de 250 mL e reavaliação mais frequente. Considerar adrenalina EV se refratário.":
    "CHOQUE ANAFILÁCTICO — adrenalina IM inmediata, dos accesos, cristaloide 1.000–2.000 mL rápido en el adulto (20 mL/kg en el niño), EN ALÍCUOTAS de 500 mL, reevaluando perfusión y congestión tras CADA una — el volumen se titula, no se prescribe de una vez. Cardiópata, disfunción renal, adulto mayor o gestante: alícuotas de 250 mL y reevaluación más frecuente. Considerar adrenalina EV si es refractario.",
  "Cristaloide balanceado 15–20 mL/kg na 1ª hora, em alíquotas com reavaliação (menor em cardiopata, disfunção renal ou idoso)":
    "Cristaloide balanceado 15–20 mL/kg en la 1.ª hora, en alícuotas con reevaluación (menor en cardiópata, disfunción renal o adulto mayor)",
  "Cristaloide balanceado 15–20 mL/kg na 1ª hora, em alíquotas com reavaliação — reduzir em cardiopata, disfunção renal ou idoso, pelo risco de sobrecarga (se protocolo local permitir)":
    "Cristaloide balanceado 15–20 mL/kg en la 1.ª hora, en alícuotas con reevaluación — reducir en cardiópata, disfunción renal o adulto mayor, por el riesgo de sobrecarga (si el protocolo local lo permite)",
  "FLUIDOS: manter acesso venoso; se hipotensão leve persistir, cristaloide 1.000–2.000 mL rápido no adulto (20 mL/kg na criança), EM ALÍQUOTAS de 500 mL, reavaliando perfusão e congestão após CADA uma — o volume é titulado, não prescrito de uma vez. Cardiopata, disfunção renal, idoso ou gestante: alíquotas de 250 mL e reavaliação mais frequente.":
    "LÍQUIDOS: mantener acceso venoso; si persiste hipotensión leve, cristaloide 1.000–2.000 mL rápido en el adulto (20 mL/kg en el niño), EN ALÍCUOTAS de 500 mL, reevaluando perfusión y congestión tras CADA una — el volumen se titula, no se prescribe de una vez. Cardiópata, disfunción renal, adulto mayor o gestante: alícuotas de 250 mL y reevaluación más frecuente.",
  "INFUSÃO CONTÍNUA quando houver recorrência ou opioide de ação longa: dose por hora = DOIS TERÇOS da dose total que reverteu a ventilação. Ex.: reverteu com 1,2 mg → 0,8 mg/h. Titular pela frequência respiratória, não pelo nível de consciência.":
    "INFUSIÓN CONTINUA cuando haya recurrencia u opioide de acción prolongada: dosis por hora = DOS TERCIOS de la dosis total que revirtió la ventilación. Ej.: revirtió con 1,2 mg → 0,8 mg/h. Titular por la frecuencia respiratoria, no por el nivel de conciencia.",
  "SF 0,9% 15–20 mL/kg na 1ª hora, em alíquotas com reavaliação (expansão inicial padrão; reduzir se ICC, DRC ou idoso)":
    "SF 0,9% 15–20 mL/kg en la 1.ª hora, en alícuotas con reevaluación (expansión inicial estándar; reducir si ICC, ERC o adulto mayor)",
  "SF 0,9% 15–20 mL/kg na 1ª hora, em alíquotas com reavaliação (reduzir em ICC, DRC ou idoso)":
    "SF 0,9% 15–20 mL/kg en la 1.ª hora, en alícuotas con reevaluación (reducir en ICC, ERC o adulto mayor)",
  "Volume: SF 0,9% 15–20 mL/kg na 1ª hora, em alíquotas com reavaliação (ajustar em ICC, IRC ou idoso); depois conforme balanço e Na corrigida.":
    "Volumen: SF 0,9% 15–20 mL/kg en la 1.ª hora, en alícuotas con reevaluación (ajustar en ICC, IRC o adulto mayor); luego según balance y Na corregido.",
  "④ ACESSO E VOLUME — se hipotensão/choque, obter DOIS acessos periféricos calibrosos e fazer cristaloide 1.000–2.000 mL rápido no adulto (20 mL/kg na criança), EM ALÍQUOTAS de 500 mL, reavaliando perfusão e congestão após CADA uma — o volume é titulado, não prescrito de uma vez. Cardiopata, disfunção renal, idoso ou gestante: alíquotas de 250 mL e reavaliação mais frequente. No choque refratário podem ser necessários 4–8 L nas primeiras horas, e aí a vigilância de sobrecarga passa a ser contínua.":
    "④ ACCESO Y VOLUMEN — si hay hipotensión/choque, obtener DOS accesos periféricos gruesos y administrar cristaloide 1.000–2.000 mL rápido en el adulto (20 mL/kg en el niño), EN ALÍCUOTAS de 500 mL, reevaluando perfusión y congestión tras CADA una — el volumen se titula, no se prescribe de una vez. Cardiópata, disfunción renal, adulto mayor o gestante: alícuotas de 250 mL y reevaluación más frecuente. En el choque refractario pueden ser necesarios 4–8 L en las primeras horas, y entonces la vigilancia de sobrecarga pasa a ser continua.",
  ...
  "ANALGESIA NÃO MASCARA o diagnóstico nem atrasa a cirurgia — isso está estabelecido e o mito ainda custa horas de dor a muito paciente. Tratar a dor melhora o exame, porque o abdome relaxa.":
    "La ANALGESIA NO ENMASCARA el diagnóstico ni retrasa la cirugía — está establecido, y el mito todavía le cuesta horas de dolor a mucho paciente. Tratar el dolor mejora el examen, porque el abdomen se relaja.",
  "CAD LEVE ou MODERADA não complicada: o consenso ADA/EASD 2024 RECOMENDA formalmente o análogo rápido SUBCUTÂNEO a cada 1–2 h como alternativa à infusão IV — evita a UTI. Esquema clássico com insulina regular SC: {scBolus} U (0,3 U/kg) → {scRepeat} U (0,2 U/kg) a cada 2 h.":
    "CAD LEVE o MODERADA no complicada: el consenso ADA/EASD 2024 RECOMIENDA formalmente el análogo rápido SUBCUTÁNEO cada 1–2 h como alternativa a la infusión IV — evita la UCI. Esquema clásico con insulina regular SC: {scBolus} U (0,3 U/kg) → {scRepeat} U (0,2 U/kg) cada 2 h.",
  "CHAME A CIRURGIA sem ter o padrão definido. Não é preciso o diagnóstico pronto para pedir avaliação: dúvida em abdome agudo já é motivo, e a demora até a cirurgia é o que piora o desfecho.":
    "LLAME A CIRUGÍA sin tener el patrón definido. No hace falta el diagnóstico cerrado para pedir la evaluación: la duda en abdomen agudo ya es motivo, y la demora hasta la cirugía es lo que empeora el desenlace.",
  "Cristaloide balanceado (preferido) ou SF 0,9%, 500–1.000 mL/h nas primeiras 2–4 h (consenso ADA/EASD 2024), preferindo CRISTALOIDE BALANCEADO — menos acidose hiperclorêmica e alta mais precoce que o SF 0,9%. Reduzir em cardiopatia ou comprometimento renal: a própria diretriz condiciona essa velocidade a quem NÃO os tem":
    "Cristaloide balanceado (preferido) o SF 0,9%, 500–1.000 mL/h en las primeras 2–4 h (consenso ADA/EASD 2024), prefiriendo CRISTALOIDE BALANCEADO — menos acidosis hiperclorémica y alta más precoz que el SF 0,9%. Reducir en cardiopatía o compromiso renal: la propia guía condiciona esa velocidad a quien NO los tiene",
  "Cristaloide balanceado 500–1.000 mL/h nas primeiras 2–4 h (consenso ADA/EASD 2024), preferindo CRISTALOIDE BALANCEADO — menos acidose hiperclorêmica e alta mais precoce que o SF 0,9%. Reduzir em cardiopatia ou comprometimento renal: a própria diretriz condiciona essa velocidade a quem NÃO os tem":
    "Cristaloide balanceado 500–1.000 mL/h en las primeras 2–4 h (consenso ADA/EASD 2024), prefiriendo CRISTALOIDE BALANCEADO — menos acidosis hiperclorémica y alta más precoz que el SF 0,9%. Reducir en cardiopatía o compromiso renal: la propia guía condiciona esa velocidad a quien NO los tiene",
  "ENQUANTO ESPERA A IMAGEM, procure os quatro achados que mudam a rota sozinhos: abdome em tábua (perfuração), dor desproporcional ao exame (isquemia mesentérica), massa pulsátil expansiva (aneurisma) e parada de eliminação de gases e fezes com distensão (obstrução).":
    "MIENTRAS ESPERA LA IMAGEN, busque los cuatro hallazgos que cambian la ruta por sí solos: abdomen en tabla (perforación), dolor desproporcionado al examen (isquemia mesentérica), masa pulsátil expansiva (aneurisma) y detención de la eliminación de gases y heces con distensión (obstrucción).",
  "EXAMES: hemograma, PCR, eletrólitos, função renal, glicemia, amilase/lipase, TGO/TGP, bilirrubinas, coagulograma, gasometria com LACTATO, urina e β-hCG em toda mulher em idade fértil — o β-hCG muda o diagnóstico e ninguém pergunta o suficiente.":
    "EXÁMENES: hemograma, PCR, electrolitos, función renal, glucemia, amilasa/lipasa, TGO/TGP, bilirrubinas, coagulograma, gasometría con LACTATO, orina y β-hCG en toda mujer en edad fértil — el β-hCG cambia el diagnóstico y casi nadie pregunta lo suficiente.",
  "EXPANSÃO INICIAL: 500–1.000 mL/h nas primeiras 2–4 h (consenso ADA/EASD 2024), preferindo CRISTALOIDE BALANCEADO — menos acidose hiperclorêmica e alta mais precoce que o SF 0,9%. Reduzir em cardiopatia ou comprometimento renal: a própria diretriz condiciona essa velocidade a quem NÃO os tem. Em choque, alíquotas de 500 mL em 15–30 min, repetindo até PAS ≥ 90 mmHg.":
    "EXPANSIÓN INICIAL: 500–1.000 mL/h en las primeras 2–4 h (consenso ADA/EASD 2024), prefiriendo CRISTALOIDE BALANCEADO — menos acidosis hiperclorémica y alta más precoz que el SF 0,9%. Reducir en cardiopatía o compromiso renal: la propia guía condiciona esa velocidad a quien NO los tiene. En choque, alícuotas de 500 mL en 15–30 min, repitiendo hasta PAS ≥ 90 mmHg.",
  "Expansão inicial / 500–1.000 mL/h nas primeiras 2–4 h (consenso ADA/EASD 2024), preferindo CRISTALOIDE BALANCEADO — menos acidose hiperclorêmica e alta mais precoce que o SF 0,9%. Reduzir em cardiopatia ou comprometimento renal: a própria diretriz condiciona essa velocidade a quem NÃO os tem":
    "Expansión inicial / 500–1.000 mL/h en las primeras 2–4 h (consenso ADA/EASD 2024), prefiriendo CRISTALOIDE BALANCEADO — menos acidosis hiperclorémica y alta más precoz que el SF 0,9%. Reducir en cardiopatía o compromiso renal: la propia guía condiciona esa velocidad a quien NO los tiene",
  "FAÇA AGORA, vale para qualquer padrão: jejum, dois acessos calibrosos, cristaloide conforme a perfusão, analgesia, antiemético e monitorização.":
    "HAGA AHORA, vale para cualquier patrón: ayuno, dos accesos gruesos, cristaloide según la perfusión, analgesia, antiemético y monitorización.",
  "IMAGEM É QUEM DEFINE O PADRÃO. Tomografia de abdome com contraste é o exame que responde à sua dúvida na maioria dos casos. Ultrassom à beira do leito antes, se disponível: vê líquido livre, aorta, vesícula e hidronefrose em minutos.":
    "LA IMAGEN ES QUIEN DEFINE EL PATRÓN. La tomografía de abdomen con contraste es el examen que responde a su duda en la mayoría de los casos. Ecografía junto a la cama antes, si está disponible: ve líquido libre, aorta, vesícula e hidronefrosis en minutos.",
  "Idoso, diabético, imunossuprimido, em corticoide ou gestante: o exame ENGANA — pode não haver defesa, febre nem leucocitose com víscera perfurada. Nesses, baixe o limiar para imagem e para acionar a cirurgia.":
    "Adulto mayor, diabético, inmunosuprimido, en corticoides o gestante: el examen ENGAÑA — puede no haber defensa, fiebre ni leucocitosis con víscera perforada. En ellos, baje el umbral para la imagen y para llamar a cirugía.",
  ...
  "Não precisa definir o padrão para começar":
    "No hace falta definir el patrón para empezar",
  "REEXAMINE O ABDOME EM SÉRIE, de preferência com o mesmo examinador. O padrão que não estava claro na primeira hora costuma se declarar na terceira — abdome agudo é diagnóstico em movimento.":
    "REEXAMINE EL ABDOMEN EN SERIE, de preferencia con el mismo examinador. El patrón que no estaba claro en la primera hora suele declararse en la tercera — el abdomen agudo es un diagnóstico en movimiento.",
  "Sem sinal de catástrofe, o começo é o MESMO nos cinco padrões. O padrão decide o tratamento definitivo — e quem o define é a imagem, não o exame inicial.":
    "Sin signo de catástrofe, el comienzo es el MISMO en los cinco patrones. El patrón decide el tratamiento definitivo — y quien lo define es la imagen, no el examen inicial.",
  "Tenho certeza do abdome agudo, mas NÃO do padrão":
    "Tengo certeza del abdomen agudo, pero NO del patrón",

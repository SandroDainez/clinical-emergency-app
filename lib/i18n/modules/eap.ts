...
export const ES_EAP: Record<string, string> = {
  ...
  "⛔ Não usar morfina/opioides de rotina no EAP/insuficiência cardíaca aguda (ESC 2021, Classe III); uso excepcional apenas para dor ou ansiedade graves/intratáveis quando outras medidas falharam.": "⛔ No usar morfina/opioides de rutina en el EAP/insuficiencia cardíaca aguda (ESC 2021, Clase III); uso excepcional solo para dolor o ansiedad graves/intratables cuando hayan fallado otras medidas.",
  "⛔ Morfina/opioides NÃO devem ser usados de rotina no EAP/insuficiência cardíaca aguda (ESC 2021, Classe III); reservar apenas para dor ou ansiedade graves/intratáveis que não possam ser controladas de outra forma.": "⛔ La morfina/los opioides NO deben usarse de rutina en el EAP/insuficiencia cardíaca aguda (ESC 2021, Clase III); reservarlos solo para dolor o ansiedad graves/intratables que no puedan controlarse de otra forma.",
  // ── Evidência ──────────────────────────────────────────────────────────────

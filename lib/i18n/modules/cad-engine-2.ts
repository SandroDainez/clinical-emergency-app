...
export const ES_CAD_ENGINE_2: Record<string, string> = {
  ...
  "Velocidade de correção": "Velocidad de corrección",
  "Não baixar o sódio mais que 8–10 mEq/L em 24 h (≈ 0,5 mEq/L/h). Na hipernatremia CRÔNICA ou de duração incerta, ficar no limite inferior.": "No bajar el sodio más de 8–10 mEq/L en 24 h (≈ 0,5 mEq/L/h). En la hipernatremia CRÓNICA o de duración incierta, quedarse en el límite inferior.",
  "O dano da correção rápida é EDEMA CEREBRAL, com convulsão e rebaixamento: o cérebro adaptado à hipertonicidade acumulou osmóis, e quando o plasma cai depressa a água entra na célula. É o espelho da desmielinização da hiponatremia — mesma pressa, dano oposto.": "El daño de la corrección rápida es el EDEMA CEREBRAL, con convulsión y deterioro de conciencia: el cerebro adaptado a la hipertonicidad acumuló osmoles, y cuando el plasma cae deprisa el agua entra en la célula. Es el espejo de la desmielinización de la hiponatremia — la misma prisa, el daño opuesto.",
  "A meta automática desta tela já respeita o teto de 8 mEq/L em 24 h. Reavaliar o sódio a cada 4 h e recalcular: se estiver caindo mais rápido que o previsto, reduzir a velocidade ou trocar por solução com mais sódio.": "La meta automática de esta pantalla ya respeta el techo de 8 mEq/L en 24 h. Reevaluar el sodio cada 4 h y recalcular: si está cayendo más rápido de lo previsto, reducir la velocidad o cambiar a una solución con más sodio.",
  "Hipernatremia AGUDA (instalada em < 48 h, tipicamente iatrogênica ou por perda súbita de água livre) tolera correção mais rápida — o cérebro ainda não se adaptou. A distinção agudo × crônico vem antes da escolha da velocidade.": "La hipernatremia AGUDA (instalada en < 48 h, típicamente iatrogénica o por pérdida súbita de agua libre) tolera una corrección más rápida — el cerebro aún no se ha adaptado. La distinción agudo × crónico viene antes de elegir la velocidad.",
  "Necessidade estimada da etapa inicial: {0} g de gluconato de cálcio 10% ({1} mL da solução 10%) = ~{2} mg de cálcio ELEMENTAR.": "Necesidad estimada de la etapa inicial: {0} g de gluconato de calcio 10% ({1} mL de la solución 10%) = ~{2} mg de calcio ELEMENTAL.",
  "⚠️ MESMA quantidade de cálcio elementar com CLORETO de cálcio 10%: apenas {0} mL (~{1} mg elementar). 1 mL de cloreto tem 1,36 mEq de Ca contra 0,465 mEq do gluconato — o cloreto é ~3× mais concentrado em cálcio elementar. Trocar um pelo outro na proporção 1:1 erra por 3× em uma das direções.": "⚠️ La MISMA cantidad de calcio elemental con CLORURO de calcio 10%: solo {0} mL (~{1} mg elemental). 1 mL de cloruro tiene 1,36 mEq de Ca frente a 0,465 mEq del gluconato — el cloruro es ~3× más concentrado en calcio elemental. Cambiar uno por otro en proporción 1:1 yerra por 3× en una de las direcciones.",
  "QUAL DOS DOIS — é escolha por CONTEXTO, não por disponibilidade. CLORETO: preferido na PCR, na hipercalemia com alteração de ECG e na hipocalcemia com instabilidade — entrega mais cálcio elementar mais rápido. Exige acesso CENTRAL de preferência: é muito mais esclerosante e a extravasação causa necrose. GLUCONATO: preferido em acesso periférico e quando não há urgência elétrica, por ser bem menos irritante.": "CUÁL DE LOS DOS — es elección por CONTEXTO, no por disponibilidad. CLORURO: preferido en el PCR, en la hipercalemia con alteración del ECG y en la hipocalcemia con inestabilidad — entrega más calcio elemental más rápido. Exige acceso CENTRAL de preferencia: es mucho más esclerosante y la extravasación causa necrosis. GLUCONATO: preferido en acceso periférico y cuando no hay urgencia eléctrica, por ser bastante menos irritante.",
  "Fonte da estratégia de correção do sódio: Spasovski G, et al. Clinical practice guideline on diagnosis and treatment of hyponatraemia. Intensive Care Med. 2014;40:320–331 (ESICM · ESE · ERA-EDTA/ERBP) — de onde vêm o teto de correção, o bólus de resgate na neurogravidade e a conduta na sobrecorreção.": "Fuente de la estrategia de corrección del sodio: Spasovski G, et al. Clinical practice guideline on diagnosis and treatment of hyponatraemia. Intensive Care Med. 2014;40:320–331 (ESICM · ESE · ERA-EDTA/ERBP) — de donde vienen el techo de corrección, el bolo de rescate en la neurogravedad y la conducta en la sobrecorrección.",
  "Se torsades: 1–2 g IV em 5–15 min com monitorização contínua — 2 g se houver instabilidade. Mesma faixa do módulo de Taquicardia.": "Si hay torsades: 1–2 g IV en 5–15 min con monitorización continua — 2 g si hay inestabilidad. Mismo rango que el módulo de Taquicardia.",
  "⚠️ GESTANTE OU PUÉRPERA COM SÍNDROME HIPERTENSIVA: estas doses são de REPOSIÇÃO de magnésio e NÃO servem para sulfatação. Pré-eclâmpsia e eclâmpsia usam esquema próprio (Pritchard ou Zuspan), com dose de ataque muito maior, tríade de segurança e gluconato de cálcio como antídoto — ver o módulo de Pré-eclâmpsia e eclâmpsia.": "⚠️ GESTANTE O PUÉRPERA CON SÍNDROME HIPERTENSIVO: estas dosis son de REPOSICIÓN de magnesio y NO sirven para la sulfatación. La preeclampsia y la eclampsia usan un esquema propio (Pritchard o Zuspan), con dosis de ataque mucho mayor, tríada de seguridad y gluconato de calcio como antídoto — ver el módulo de Preeclampsia y eclampsia.",
};

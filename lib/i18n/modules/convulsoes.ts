...
export const ES_CONVULSOES: Record<string, string> = {
  ...
  "SEM acesso IV — Midazolam 10 mg IM, dose FIXA no adulto (2 mL da ampola de 5 mg/mL) — via IM é tão eficaz quanto IV (estudo RAMPART, que usou 10 mg acima de 40 kg). Não calcular por peso: o teto de 10 mg satura em 50 kg, então quase todo adulto receberia 10 mg de qualquer forma e o cálculo só adiciona oportunidade de erro no meio de uma crise.": "SIN acceso IV — Midazolam 10 mg IM, dosis FIJA en el adulto (2 mL de la ampolla de 5 mg/mL) — la vía IM es tan eficaz como la IV (estudio RAMPART, que usó 10 mg por encima de 40 kg). No calcular por peso: el techo de 10 mg se satura en 50 kg, así que casi todo adulto recibiría 10 mg de todos modos y el cálculo solo agrega oportunidad de error en medio de una crisis.",
  "Começou agora": "Comenzó ahora",
  "Há quanto tempo a crise começou?": "¿Hace cuánto tiempo comenzó la crisis?",
  "Não sei": "No sé",
  "Tempo desde o início da crise": "Tiempo desde el inicio de la crisis",
  "Toque no tempo decorrido. É daqui que TODAS as fases contam — não do momento em que o app foi aberto.": "Toque el tiempo transcurrido. Es desde aquí que TODAS las fases cuentan — no desde el momento en que se abrió la app.",
  "mais de 40 min": "más de 40 min",
  "~10 min": "~10 min",
  "~2 min": "~2 min",
  "~20 min": "~20 min",
  "~5 min": "~5 min",
  "⏱️ 20 MIN DE CRISE — a 1ª linha falhou. Passar para o antiepiléptico IV de 2ª linha; não repetir benzodiazepínico uma terceira vez.": "⏱️ 20 MIN DE CRISIS — la 1.ª línea falló. Pasar al antiepiléptico IV de 2.ª línea; no repetir la benzodiacepina una tercera vez.",
  "⏱️ 40 MIN DE CRISE — estado de mal REFRATÁRIO. Anestésico contínuo + IOT + EEG.": "⏱️ 40 MIN DE CRISIS — estado de mal REFRACTARIO. Anestésico continuo + intubación + EEG.",
  "⏱️ 5 MIN DE CRISE — é mal epiléptico. Administrar o benzodiazepínico AGORA; a estabilização segue em paralelo, não antes.": "⏱️ 5 MIN DE CRISIS — es estado de mal epiléptico. Administrar la benzodiacepina AHORA; la estabilización sigue en paralelo, no antes.",
  "⏱️ 5 min da dose — o benzodiazepínico pode ser repetido UMA vez se a crise persistir. Uma, não mais.": "⏱️ 5 min de la dosis — la benzodiacepina puede repetirse UNA vez si la crisis persiste. Una, no más.",
  "⏱️ 60 MIN DE CRISE. Se o anestésico já corre, o relógio que decide passa a ser o DELE: superrefratário é crise que persiste ou recorre após 24 h de infusão adequada.": "⏱️ 60 MIN DE CRISIS. Si el anestésico ya corre, el reloj que decide pasa a ser el DE ÉL: superrefractario es la crisis que persiste o recurre tras 24 h de infusión adecuada.",
  "⏱️ O repique do benzodiazepínico já venceu. Duas doses é o teto: se a crise persiste, o caminho é a 2ª linha.": "⏱️ La repetición de la benzodiacepina ya venció. Dos dosis es el tope: si la crisis persiste, el camino es la 2.ª línea.",
  "⏱️ Passou dos 20 min ainda na 1ª linha. A 2ª linha está atrasada — esta é a pendência.": "⏱️ Pasaron los 20 min y sigue en la 1.ª línea. La 2.ª línea está atrasada — esta es la pendencia.",

...
export const ES_VENTILACAO: Record<string, string> = {
  ...
  "ELEGIBILIDADE, EM NÚMEROS (ACCP/ATS 2017): causa reversível ou controlada; SpO₂ ≥ 90% com FiO₂ ≤ 0,40 e PEEP ≤ 8 (ou P/F ≥ 150–200); sem vasopressor, ou em dose baixa e estável (noradrenalina ≤ 0,1 mcg/kg/min).":
    "ELEGIBILIDAD, EN NÚMEROS (ACCP/ATS 2017): causa reversible o controlada; SpO₂ ≥ 90% con FiO₂ ≤ 0,40 y PEEP ≤ 8 (o P/F ≥ 150–200); sin vasopresor, o en dosis baja y estable (noradrenalina ≤ 0,1 mcg/kg/min).",  "Indicação/objetivo: oferecer suporte invasivo quando houver falha de oxigenação ou ventilação apesar do suporte adequado, incapacidade de proteger a via aérea, trabalho respiratório/fadiga incompatíveis com ventilação sustentável ou deterioração previsível que torne a intubação posterior mais arriscada. P/F, pH, PaCO₂, frequência respiratória e GCS medem gravidade, mas nenhum corte isolado é requisito universal para iniciar ventilação invasiva.": "Indicación/objetivo: ofrecer soporte invasivo cuando exista fracaso de oxigenación o ventilación a pesar del soporte adecuado, incapacidad para proteger la vía aérea, trabajo respiratorio/fatiga incompatibles con una ventilación sostenible o deterioro previsible que haga más riesgosa una intubación posterior. P/F, pH, PaCO₂, frecuencia respiratoria y GCS miden gravedad, pero ningún punto de corte aislado es un requisito universal para iniciar ventilación invasiva.",
  "Gasometria arterial quando clinicamente indicada após estabilização ou mudanças ventilatórias relevantes; capnografia, oximetria e curvas orientam reavaliação contínua. Não impor um intervalo universal fixo.": "Gasometría arterial cuando esté clínicamente indicada tras la estabilización o cambios ventilatorios relevantes; la capnografía, la oximetría y las curvas orientan la reevaluación continua. No imponer un intervalo universal fijo.",
  "Frequência respiratória e ventilação-minuto devem ser ajustadas à fisiologia e ao distúrbio ácido-base. Em adulto sem grande alteração metabólica/obstrutiva, 12–16/min pode ser um ponto de partida, mas NÃO forçar PaCO₂ 35–45 ou pH normal antes de considerar o cenário; TCE, obstrução e acidose metabólica têm alvos próprios nos ramos abaixo. Vigiar auto-PEEP e ajustar I:E/fluxo ao tempo expiratório necessário.": "La frecuencia respiratoria y la ventilación minuto deben ajustarse a la fisiología y al trastorno ácido-base. En un adulto sin gran alteración metabólica/obstructiva, 12–16/min puede ser un punto de partida, pero NO forzar PaCO₂ 35–45 ni pH normal antes de considerar el escenario; TCE, obstrucción y acidosis metabólica tienen objetivos propios en las ramas siguientes. Vigilar auto-PEEP y ajustar I:E/flujo al tiempo espiratorio necesario.",
  "PEEP e FiO₂ não têm um único par correto para todos. Em pulmão sem hipoxemia importante, PEEP 5 cmH₂O é um ponto de partida comum; SARA/obesidade podem exigir PEEP maior e obstrução pode exigir outra estratégia. Após a intubação, usar FiO₂ suficiente para segurança imediata e titular para a menor FiO₂ que alcance o alvo de oxigenação apropriado ao cenário, evitando hiperóxia.": "PEEP y FiO₂ no tienen un único par correcto para todos. En un pulmón sin hipoxemia importante, PEEP 5 cmH₂O es un punto de partida común; SARA/obesidad pueden exigir PEEP mayor y la obstrucción puede requerir otra estrategia. Tras la intubación, usar FiO₂ suficiente para la seguridad inmediata y titular a la menor FiO₂ que alcance el objetivo de oxigenación apropiado al escenario, evitando hiperoxia.",
  ...
  "A pressão de platô está dentro do alvo do cenário e a mecânica está estável ou melhorando?": "¿La presión meseta está dentro del objetivo del escenario y la mecánica está estable o mejorando?",
  "Sim — mecânica aceitável": "Sí — mecánica aceptable",
  "Não — Pplat alta ou mecânica piorando": "No — Pplat elevada o mecánica empeorando",
  "Driving pressure = platô − PEEP. Monitorar tendência e reduzir estresse mecânico quando possível; valores menores costumam associar-se a melhor prognóstico, mas 15 cmH₂O não deve funcionar como corte universal isolado para todos os cenários.": "Driving pressure = meseta − PEEP. Monitorizar la tendencia y reducir el estrés mecánico cuando sea posible; los valores menores suelen asociarse con mejor pronóstico, pero 15 cmH₂O no debe funcionar como punto de corte universal aislado para todos los escenarios.",
  ...
  "Deterioração ameaçadora: priorizar oxigenação/ventilação e percorrer DOPES. Se necessário, desconectar do ventilador e ventilar manualmente com BVM em O₂ 100% enquanto avalia D: deslocamento/seletivo do tubo; O: obstrução/secreção/dobra; P: pneumotórax hipertensivo; E: equipamento/circuito; S: stacking/auto-PEEP. Pneumotórax hipertensivo com instabilidade é diagnóstico clínico (POCUS ajuda sem atrasar): descomprimir imediatamente. Em parada/hipotensão grave e equipe habilitada, toracostomia aberta/finger é opção efetiva; descompressão por agulha deve usar cateter adequado e sítio conforme protocolo/anatomia (4º–5º EIC linha axilar anterior ou 2º EIC linha médio-clavicular), seguida de drenagem definitiva.": "Deterioro amenazante: priorizar oxigenación/ventilación y recorrer DOPES. Si es necesario, desconectar del ventilador y ventilar manualmente con bolsa-válvula-mascarilla y O₂ al 100% mientras se evalúa D: desplazamiento/selectividad del tubo; O: obstrucción/secreciones/acodamiento; P: neumotórax a tensión; E: equipo/circuito; S: stacking/auto-PEEP. El neumotórax a tensión con inestabilidad es un diagnóstico clínico (POCUS ayuda sin retrasar): descomprimir de inmediato. En paro/hipotensión grave y con equipo capacitado, la toracostomía abierta/digital es una opción eficaz; la descompresión con aguja debe usar un catéter adecuado y un sitio según protocolo/anatomía (4º–5º EIC línea axilar anterior o 2º EIC línea medioclavicular), seguida de drenaje definitivo.",
  "⚠️ HIPERINSUFLAÇÃO DINÂMICA COM INSTABILIDADE (hipotensão súbita/AESP, fluxo expiratório sem retornar a zero): desconectar brevemente do ventilador para permitir expiração e corrigir FR, tempo expiratório, fluxo e Vt. Em asma grave/peri-parada, compressão manual do tórax pode ser considerada por equipe experiente para ajudar a aliviar hiperinsuflação. Não assumir auto-PEEP se a instabilidade persistir: excluir pneumotórax hipertensivo e outras causas imediatamente.": "⚠️ HIPERINFLACIÓN DINÁMICA CON INESTABILIDAD (hipotensión súbita/AESP, flujo espiratorio sin volver a cero): desconectar brevemente del ventilador para permitir la espiración y corregir FR, tiempo espiratorio, flujo y Vt. En asma grave/periparo, la compresión manual del tórax puede considerarse por un equipo experimentado para ayudar a aliviar la hiperinsuflación. No asumir auto-PEEP si la inestabilidad persiste: excluir inmediatamente neumotórax a tensión y otras causas.",
  "Hipoxemia refratária: confirmar tubo/circuito e causas reversíveis; otimizar FiO₂ e PEEP conforme estratégia do cenário. Na SARA, pronar quando critérios forem preenchidos; bloqueio neuromuscular apenas em selecionados quando assincronia/drive impedir ventilação protetora. Manobras de recrutamento de alta pressão não são rotina e as prolongadas devem ser evitadas.": "Hipoxemia refractaria: confirmar tubo/circuito y causas reversibles; optimizar FiO₂ y PEEP según la estrategia del escenario. En SDRA, pronar cuando se cumplan los criterios; bloqueo neuromuscular solo en pacientes seleccionados cuando la asincronía/drive impida la ventilación protectora. Las maniobras de reclutamiento de alta presión no son de rutina y las prolongadas deben evitarse.",
  "Prioridade: minimizar hiperinsuflação dinâmica, garantir expiração completa e titular PEEP/ventilação pela mecânica, não pela normalização da PaCO₂.": "Prioridad: minimizar la hiperinsuflación dinámica, garantizar una espiración completa y titular PEEP/ventilación según la mecánica, no mediante la normalización de la PaCO₂.",
  "VC 6–8 mL/kg PBW ({vc6}–{vc8} mL). Iniciar com FR baixa/moderada (por exemplo, ~10–12/min em obstrução grave) e titular pela expiração completa, auto-PEEP, pH e ventilação-minuto; não perseguir PaCO₂ normal às custas de hiperinsuflação.": "Vt 6–8 mL/kg de peso predicho ({vc6}–{vc8} mL). Iniciar con FR baja/moderada (por ejemplo, ~10–12/min en obstrucción grave) y titular según espiración completa, auto-PEEP, pH y ventilación minuto; no perseguir una PaCO₂ normal a costa de hiperinsuflación.",
  "Encurtar o tempo inspiratório e prolongar a expiração: I:E frequentemente 1:3–1:4 e fluxo inspiratório alto (~60–100 L/min) são pontos de partida, ajustados pelas curvas e pelo retorno do fluxo expiratório a zero antes do próximo ciclo.": "Acortar el tiempo inspiratorio y prolongar la espiración: I:E frecuentemente 1:3–1:4 y flujo inspiratorio alto (~60–100 L/min) son puntos de partida, ajustados según las curvas y el retorno del flujo espiratorio a cero antes del siguiente ciclo.",
  "PEEP externa: não aplicar uma fórmula universal. Em paciente passivo/controlado com hiperinsuflação, priorizar tempo expiratório e PEEP baixa conforme mecânica. Em DPOC com esforço espontâneo, auto-PEEP e dificuldade de disparo, PEEP externa pode reduzir trabalho/trigger; titular abaixo da PEEPi medida (frequentemente ~50–80%, cerca de 70% como referência) observando PEEP total, volume expirado, hemodinâmica e hiperinsuflação.": "PEEP externa: no aplicar una fórmula universal. En paciente pasivo/controlado con hiperinsuflación, priorizar tiempo espiratorio y PEEP baja según la mecánica. En EPOC con esfuerzo espontáneo, auto-PEEP y dificultad de disparo, la PEEP externa puede reducir trabajo/trigger; titular por debajo de la PEEPi medida (frecuentemente ~50–80%, alrededor de 70% como referencia) observando PEEP total, volumen espirado, hemodinamia e hiperinsuflación.",
  "Hipercapnia permissiva: aceitar elevação da PaCO₂ quando necessária para evitar hiperinsuflação; não existe PaCO₂-alvo universal. Guiar tolerância por pH, hemodinâmica e contraindicações à hipercapnia. Na exacerbação de DPOC com risco de retenção de CO₂, titular oxigênio de forma controlada (alvo usual SpO₂ 88–92% enquanto se avaliam gasometria e resposta), individualizando se houver indicação diversa.": "Hipercapnia permisiva: aceptar aumento de PaCO₂ cuando sea necesario para evitar hiperinsuflación; no existe un objetivo universal de PaCO₂. Guiar la tolerancia por pH, hemodinamia y contraindicaciones a la hipercapnia. En exacerbación de EPOC con riesgo de retención de CO₂, titular oxígeno de forma controlada (objetivo habitual SpO₂ 88–92% mientras se evalúan gasometría y respuesta), individualizando si existe otra indicación.",
  "Adjuvantes: manter broncodilatador inalatório no circuito. Na exacerbação asmática grave que não responde ao tratamento inicial, MgSO₄ IV 2 g em infusão única pode ser considerado; não é terapia rotineira para todos. Ketamina pode ser escolhida como agente de sedação/peri-intubação por perfil hemodinâmico e potencial broncodilatador, mas não deve ser apresentada como broncodilatador específico de eficácia comprovada. Em DPOC de alto risco, considerar suporte não invasivo pós-extubação conforme o contexto clínico.": "Adyuvantes: mantener broncodilatador inhalado en el circuito. En exacerbación asmática grave que no responde al tratamiento inicial, puede considerarse MgSO₄ IV 2 g en infusión única; no es terapia rutinaria para todos. La ketamina puede elegirse como agente de sedación/periintubación por su perfil hemodinámico y potencial broncodilatador, pero no debe presentarse como broncodilatador específico de eficacia demostrada. En EPOC de alto riesgo, considerar soporte no invasivo posextubación según el contexto clínico.",
  "Ventilar de forma protetora sem criar metas gasométricas artificiais; hemodinâmica e evolução para SARA definem os ajustes.": "Ventilar de forma protectora sin crear objetivos gasométricos artificiales; la hemodinamia y la evolución hacia SDRA definen los ajustes.",
  "Sem SARA: VC 6–8 mL/kg PBW ({vc6}–{vc8} mL) é faixa protetora razoável; se houver SARA, usar a estratégia específica com alvo ~6 mL/kg e Pplat ≤ 30. FR, I:E e PEEP devem ser titulados à ventilação, oxigenação, mecânica e hemodinâmica, sem uma PEEP fixa para todo choque séptico.": "Sin SDRA: Vt 6–8 mL/kg de peso predicho ({vc6}–{vc8} mL) es un rango protector razonable; si hay SDRA, usar la estrategia específica con objetivo ~6 mL/kg y Pmeseta ≤ 30. FR, I:E y PEEP deben titularse según ventilación, oxigenación, mecánica y hemodinamia, sin una PEEP fija para todo shock séptico.",
  "Oxigenação: titular FiO₂ conforme contexto; na insuficiência respiratória hipoxêmica associada à sepse, metas práticas costumam ficar aproximadamente entre SpO₂ 90–96%, individualizadas. Não usar PaCO₂ 35–45 nem lactato como alvos ventilatórios universais; interpretar PaCO₂ pelo distúrbio ácido-base e lactato pela perfusão/causa clínica.": "Oxigenación: titular FiO₂ según el contexto; en insuficiencia respiratoria hipoxémica asociada a sepsis, los objetivos prácticos suelen situarse aproximadamente entre SpO₂ 90–96%, individualizados. No usar PaCO₂ 35–45 ni lactato como objetivos ventilatorios universales; interpretar PaCO₂ según el trastorno ácido-base y lactato según perfusión/causa clínica.",
  "Usar a menor sedação compatível com conforto, segurança e sincronia; avaliar prontidão para liberação da VM de forma padronizada pelo menos diariamente quando a causa e a hemodinâmica permitirem.": "Usar la menor sedación compatible con confort, seguridad y sincronía; evaluar la preparación para liberación de la VM de forma estandarizada al menos diariamente cuando la causa y la hemodinamia lo permitan.",
  "ICC / EAP cardiogênico — pressão positiva titulada à hemodinâmica": "ICC / EAP cardiogénico — presión positiva titulada según la hemodinamia",
  "Pressão positiva pode melhorar congestão/oxigenação e reduzir pós-carga do VE, mas deve ser titulada à resposta respiratória e hemodinâmica.": "La presión positiva puede mejorar la congestión/oxigenación y reducir la poscarga del VI, pero debe titularse según la respuesta respiratoria y hemodinámica.",
  "Se intubado, manter ventilação protetora com VC 6–8 mL/kg PBW ({vc6}–{vc8} mL) e ajustar FR/I:E pela ventilação e mecânica, sem buscar normocapnia automática.": "Si está intubado, mantener ventilación protectora con Vt 6–8 mL/kg de peso predicho ({vc6}–{vc8} mL) y ajustar FR/I:E según ventilación y mecánica, sin buscar normocapnia automática.",
  "PEEP/pressão positiva: titular para aliviar trabalho respiratório e melhorar oxigenação/congestão, observando pressão arterial, débito e função do VD. Não usar 8–12 cmH₂O como faixa obrigatória; em choque cardiogênico ou falência de VD, aumentos de pressão intratorácica podem piorar a hemodinâmica.": "PEEP/presión positiva: titular para aliviar el trabajo respiratorio y mejorar oxigenación/congestión, observando presión arterial, gasto y función del VD. No usar 8–12 cmH₂O como rango obligatorio; en shock cardiogénico o fallo del VD, aumentos de presión intratorácica pueden empeorar la hemodinamia.",
  "Oxigênio deve tratar hipoxemia, evitando hiperóxia; ajustar FiO₂ à SpO₂ e ao contexto. PaCO₂ pode refletir fadiga/gravidade, mas 35–45 mmHg não é alvo ventilatório universal no EAP.": "El oxígeno debe tratar la hipoxemia evitando hiperoxia; ajustar FiO₂ a SpO₂ y contexto. PaCO₂ puede reflejar fatiga/gravedad, pero 35–45 mmHg no es un objetivo ventilatorio universal en EAP.",
  "Quando não há indicação imediata de intubação e o paciente coopera, CPAP/BiPAP deve ser considerada precocemente no EAP cardiogênico com desconforto respiratório; se houver falha, exaustão, rebaixamento, choque ou incapacidade de proteger via aérea, não atrasar IOT.": "Cuando no hay indicación inmediata de intubación y el paciente coopera, CPAP/BiPAP debe considerarse precozmente en EAP cardiogénico con distrés respiratorio; si hay fracaso, agotamiento, disminución del nivel de conciencia, shock o incapacidad para proteger la vía aérea, no retrasar la intubación.",
  "Obesidade — peso predito + PEEP individualizada": "Obesidad — peso predicho + PEEP individualizada",
  "VC pelo peso PREDITO (nunca o atual); PEEP e pressões devem considerar parede torácica, fechamento de via aérea e hemodinâmica.": "VC por peso PREDICHO (nunca el actual); PEEP y presiones deben considerar pared torácica, cierre de vía aérea y hemodinámica.",
  "VC 6–8 mL/kg do peso PREDITO ({vc6}–{vc8} mL) — jamais pelo peso atual. Ajustar FR pela ventilação e pela mecânica, sem perseguir normocapnia automaticamente.": "VC 6–8 mL/kg de peso PREDICHO ({vc6}–{vc8} mL), nunca por peso actual. Ajustar FR según ventilación y mecánica, sin perseguir normocapnia automáticamente.",
  "PEEP: pacientes com obesidade frequentemente necessitam níveis maiores para contrariar fechamento de via aérea/atelectasia, mas não usar 8–12 cmH₂O como faixa obrigatória. Titular à oxigenação, complacência, hemodinâmica e, quando disponível, pressão transpulmonar/EIT.": "PEEP: los pacientes con obesidad con frecuencia requieren niveles mayores para contrarrestar cierre de vía aérea/atelectasia, pero no usar 8–12 cmH₂O como rango obligatorio. Titular según oxigenación, distensibilidad, hemodinámica y, cuando esté disponible, presión transpulmonar/EIT.",
  "Posição elevada/ramped ajuda mecânica e oxigenação. Manobras de recrutamento não são rotina; considerar apenas de forma seletiva, monitorizada e evitando pressões altas/prolongadas.": "La posición elevada/ramped ayuda a la mecánica y oxigenación. Las maniobras de reclutamiento no son de rutina; considerar solo de forma selectiva, monitorizada y evitando presiones altas/prolongadas.",
  "Oxigênio e ventilação devem ser titulados ao contexto: evitar hiperóxia e reconhecer hipercapnia crônica/síndrome de hipoventilação da obesidade quando presentes. No alto risco de falha pós-extubação, considerar suporte não invasivo profilático conforme o perfil clínico.": "Oxígeno y ventilación deben titularse al contexto: evitar hiperoxia y reconocer hipercapnia crónica/síndrome de hipoventilación por obesidad cuando estén presentes. En alto riesgo de fracaso posextubación, considerar soporte no invasivo profiláctico según el perfil clínico.",
  "Acidose metabólica grave — preservar a compensação ventilatória": "Acidosis metabólica grave — preservar la compensación ventilatoria",
  "A intubação pode remover abruptamente uma compensação respiratória crítica; minimizar apneia e restaurar ventilação-minuto suficiente imediatamente após o tubo.": "La intubación puede eliminar abruptamente una compensación respiratoria crítica; minimizar la apnea y restaurar ventilación-minuto suficiente inmediatamente después del tubo.",
  "⚠️ O RISCO ESPECÍFICO AQUI é perder a compensação respiratória. Na acidose metabólica grave, o paciente pode depender de ventilação-minuto muito elevada; após a intubação, uma queda abrupta dessa ventilação pode elevar rapidamente a PaCO₂, piorar a acidemia e precipitar colapso hemodinâmico.": "⚠️ EL RIESGO ESPECÍFICO AQUÍ es perder la compensación respiratoria. En la acidosis metabólica grave, el paciente puede depender de una ventilación-minuto muy elevada; después de la intubación, una caída brusca puede elevar rápidamente la PaCO₂, empeorar la acidemia y precipitar colapso hemodinámico.",
  "PaCO₂: não buscar 35–45 mmHg por rotina. Usar a PaCO₂/ventilação pré-intubação quando disponível como referência fisiológica; a fórmula de Winter [PaCO₂ esperada ≈ 1,5 × HCO₃ + 8 (±2)] estima a compensação esperada e ajuda a reconhecer distúrbio respiratório associado, mas não substitui o estado real do paciente.": "PaCO₂: no buscar 35–45 mmHg de rutina. Usar la PaCO₂/ventilación preintubación cuando esté disponible como referencia fisiológica; la fórmula de Winter [PaCO₂ esperada ≈ 1,5 × HCO₃ + 8 (±2)] estima la compensación esperada y ayuda a reconocer un trastorno respiratorio asociado, pero no sustituye el estado real del paciente.",
  "VENTILAÇÃO-MINUTO: restaurar prontamente ventilação compatível com a compensação prévia/necessária, titulando pela PaCO₂, pH, curva de fluxo e mecânica. Não aplicar uma fórmula universal em mL/kg/min para todos os pacientes acidóticos.": "VENTILACIÓN-MINUTO: restaurar rápidamente una ventilación compatible con la compensación previa/necesaria, titulando por PaCO₂, pH, curva de flujo y mecánica. No aplicar una fórmula universal en mL/kg/min para todos los pacientes acidóticos.",
  "COMO ENTREGAR ISSO SEM ABANDONAR PROTEÇÃO: manter Vt 6–8 mL/kg PBW ({vc6}–{vc8} mL) e obter ventilação-minuto principalmente pela FR/fluxo, reavaliando Pplat, auto-PEEP e tendência da driving pressure; não usar 15 cmH₂O como corte universal isolado.": "CÓMO ENTREGARLO SIN ABANDONAR LA PROTECCIÓN: mantener Vt 6–8 mL/kg PBW ({vc6}–{vc8} mL) y obtener ventilación-minuto principalmente mediante FR/flujo, reevaluando Pplat, auto-PEEP y tendencia de driving pressure; no usar 15 cmH₂O como punto de corte universal aislado.",
  "Se a ventilação necessária não puder ser entregue sem auto-PEEP, pressões excessivas ou instabilidade, tratar agressivamente a causa da acidose e discutir terapias específicas (por exemplo, bicarbonato ou terapia renal substitutiva) apenas quando houver indicação pela etiologia, gravidade e contexto — não como resposta automática a um número de pH.": "Si la ventilación necesaria no puede administrarse sin auto-PEEP, presiones excesivas o inestabilidad, tratar agresivamente la causa de la acidosis y discutir terapias específicas (por ejemplo, bicarbonato o terapia renal sustitutiva) solo cuando estén indicadas por etiología, gravedad y contexto, no como respuesta automática a un número de pH.",
  "REAVALIAR PRECOCEMENTE após estabilizar a ventilação: gasometria e mecânica devem ser repetidas conforme a gravidade e a velocidade de mudança. Ajustar pela tendência de pH/PaCO₂ e pela compensação fisiológica esperada, sem impor intervalo fixo de 20–30 min ou alvo universal de pH.": "REEVALUAR PRECOZMENTE después de estabilizar la ventilación: gasometría y mecánica deben repetirse según la gravedad y velocidad de cambio. Ajustar por la tendencia de pH/PaCO₂ y la compensación fisiológica esperada, sin imponer un intervalo fijo de 20–30 min ni un objetivo universal de pH.",
  "PERI-INTUBAÇÃO: minimizar o tempo sem ventilação; quando viável e seguro, preservar ventilação espontânea durante preparação/pré-oxigenação e iniciar ventilação mecânica imediatamente após confirmar o tubo. Planejar antecipadamente suporte hemodinâmico e primeira tentativa bem-sucedida.": "PERIINTUBACIÓN: minimizar el tiempo sin ventilación; cuando sea viable y seguro, preservar ventilación espontánea durante preparación/preoxigenación e iniciar ventilación mecánica inmediatamente después de confirmar el tubo. Planificar de antemano soporte hemodinámico y éxito al primer intento.",
  "Mesmo com parênquima inicialmente preservado, usar Vt protetor 6–8 mL/kg PBW ({vc6}–{vc8} mL) e acompanhar Pplat/drive de forma contextual. Não aumentar Vt para compensar fraqueza muscular.": "Incluso con parénquima inicialmente preservado, usar Vt protector 6–8 mL/kg PBW ({vc6}–{vc8} mL) y seguir Pplat/drive de forma contextual. No aumentar Vt para compensar debilidad muscular.",
  "PEEP e FiO₂ devem ser tituladas à oxigenação e à mecânica; não há necessidade de PEEP alta ou manobras de recrutamento de rotina apenas por fraqueza neuromuscular. Piora desproporcional da oxigenação exige procurar atelectasia, aspiração, pneumonia ou outra doença pulmonar associada.": "PEEP y FiO₂ deben titularse según oxigenación y mecánica; no se necesita PEEP alta ni maniobras de reclutamiento de rutina solo por debilidad neuromuscular. Un deterioro desproporcionado de la oxigenación exige buscar atelectasia, aspiración, neumonía u otra enfermedad pulmonar asociada.",
  "Complicações respiratórias e ventilação prolongada são frequentes em fraqueza neuromuscular grave; evitar percentuais fixos de uma coorte como previsão individual e acompanhar trajetória clínica, secreções, tosse e infecção.": "Las complicaciones respiratorias y la ventilación prolongada son frecuentes en la debilidad neuromuscular grave; evitar porcentajes fijos de una cohorte como predicción individual y seguir la trayectoria clínica, secreciones, tos e infección.",
  "DEPURAÇÃO DE SECREÇÕES é parte central do tratamento: avaliar força da tosse e carga de secreção; usar aspiração, fisioterapia/posicionamento e técnicas de assistência à tosse quando indicadas e disponíveis.": "ELIMINACIÓN DE SECRECIONES es parte central del tratamiento: evaluar fuerza de la tos y carga de secreciones; usar aspiración, fisioterapia/posicionamiento y técnicas de asistencia a la tos cuando estén indicadas y disponibles.",
  "Liberação/extubação deve integrar trajetória da doença, força inspiratória, função bulbar, tosse/secreções, troca gasosa e tolerância ao teste espontâneo; pressão inspiratória máxima ou capacidade vital isoladas não devem decidir sozinhas.": "La liberación/extubación debe integrar trayectoria de la enfermedad, fuerza inspiratoria, función bulbar, tos/secreciones, intercambio gaseoso y tolerancia a la prueba espontánea; la presión inspiratoria máxima o la capacidad vital aisladas no deben decidir por sí solas.",
  "Pulmão sem lesão específica: iniciar com VC protetor 6–8 mL/kg PBW ({vc6}–{vc8} mL) e parâmetros convencionais de FR/I:E/PEEP, titulando ventilação, oxigenação, mecânica e hemodinâmica em vez de manter números fixos por rotina.": "Pulmón sin lesión específica: iniciar con VC protector 6–8 mL/kg PBW ({vc6}–{vc8} mL) y parámetros convencionales de FR/I:E/PEEP, titulando ventilación, oxigenación, mecánica y hemodinámica en lugar de mantener números fijos de rutina.",
  "Usar a menor FiO₂ que mantenha oxigenação adequada ao contexto clínico, evitando tanto hipoxemia quanto hiperóxia; não impor SpO₂ 94–98% como faixa universal para todo paciente ventilado.": "Usar la menor FiO₂ que mantenga oxigenación adecuada al contexto clínico, evitando tanto hipoxemia como hiperoxia; no imponer SpO₂ 94–98% como rango universal para todo paciente ventilado.",
  "Monitorar Pplat e driving pressure como parte da proteção pulmonar; Pplat ≤ 30 cmH₂O é referência importante quando aplicável, enquanto driving pressure deve ser interpretada pela tendência e pelo cenário, sem corte universal isolado.": "Monitorizar Pplat y driving pressure como parte de la protección pulmonar; Pplat ≤ 30 cmH₂O es una referencia importante cuando aplica, mientras driving pressure debe interpretarse por tendencia y escenario, sin un punto de corte universal aislado.",
  "Pós-operatório cardíaco: favorecer estratégia de fast-track/extubação precoce em pacientes selecionados e clinicamente prontos; o marco de 6 h é usado em protocolos/estudos, mas não deve obrigar extubação antes de critérios de segurança. Monitorar função do VD e hemodinâmica.": "Posoperatorio cardíaco: favorecer estrategia fast-track/extubación precoz en pacientes seleccionados y clínicamente preparados; el hito de 6 h se usa en protocolos/estudios, pero no debe obligar a extubar antes de cumplir criterios de seguridad. Monitorizar función del VD y hemodinámica.",
  "Bundle ABCDEF (dor, despertar/respiração espontânea quando apropriados, escolha de sedação, delirium, mobilização e família) e prevenção de PAV com cabeceira 30–45°, higiene oral/escovação, manejo de secreção subglótica quando disponível e pressão do cuff monitorizada. Clorexidina oral não é rotina universal; seguir protocolo/local e indicações específicas.": "Bundle ABCDEF (dolor, despertar/respiración espontánea cuando corresponda, elección de sedación, delirium, movilización y familia) y prevención de NAV con cabecera 30–45°, higiene oral/cepillado, manejo de secreción subglótica cuando esté disponible y presión del cuff monitorizada. La clorhexidina oral no es rutina universal; seguir protocolo local e indicaciones específicas.",
  "Reavaliar gasometria e mecânica conforme necessidade clínica e evolução. Considerar traqueostomia quando houver expectativa de ventilação prolongada ou outras indicações relevantes, individualizando momento, prognóstico, via aérea, secreções e objetivos de cuidado; não usar 7–14 dias como relógio obrigatório.": "Reevaluar gasometría y mecánica según necesidad clínica y evolución. Considerar traqueostomía cuando se espere ventilación prolongada u otras indicaciones relevantes, individualizando momento, pronóstico, vía aérea, secreciones y objetivos de cuidado; no usar 7–14 días como reloj obligatorio.",
  "Após extubação, monitorizar SpO₂, FR, esforço respiratório, consciência e sinais de obstrução durante o período de maior risco, com intensidade e duração definidas pelo perfil clínico em vez de uma janela obrigatória de 24–48 h.": "Tras la extubación, monitorizar SpO₂, FR, esfuerzo respiratorio, conciencia y signos de obstrucción durante el período de mayor riesgo, con intensidad y duración definidas por el perfil clínico en lugar de una ventana obligatoria de 24–48 h.",
};

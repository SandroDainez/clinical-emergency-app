...
export const ES_CHOQUE: Record<string, string> = {
  ...
  "Ácido tranexâmico no TRAUMA com sangramento ou risco de sangramento significativo: administrar o mais cedo possível e dentro de 3 h da lesão; regime da diretriz europeia: 1 g IV em 10 min seguido de 1 g IV em 8 h. Não aguardar tromboelastometria/viscoelastometria para iniciar TXA quando ele estiver indicado.":
    "Ácido tranexámico en TRAUMA con sangrado o riesgo de sangrado significativo: administrar lo antes posible y dentro de las 3 h de la lesión; régimen de la guía europea: 1 g IV en 10 min seguido de 1 g IV en 8 h. No esperar tromboelastometría/viscoelastometría para iniciar TXA cuando esté indicado.",
  "Coagulação: iniciar monitorização e suporte hemostático imediatamente. Usar PT/INR, fibrinogênio de Clauss, plaquetas e/ou viscoelastometria conforme disponibilidade e repetir conforme evolução. Se houver hemorragia maciça esperada, ativar protocolo de transfusão maciça/ressuscitação hemostática local; após os primeiros componentes, direcionar a terapia pelos resultados, evitando reposição empírica prolongada sem monitorização.":
    "Coagulación: iniciar monitorización y soporte hemostático de inmediato. Usar PT/INR, fibrinógeno de Clauss, plaquetas y/o viscoelastometría según disponibilidad y repetir según evolución. Si se espera hemorragia masiva, activar el protocolo local de transfusión masiva/reanimación hemostática; después de los primeros componentes, dirigir la terapia por los resultados, evitando reposición empírica prolongada sin monitorización.",

...
export const ES_SEPSE: Record<string, string> = {
  ...
  "⚠️ ESTA PRIMEIRA DOSE DE BETALACTÂMICO NÃO SE AJUSTA POR FUNÇÃO RENAL — E NEM DEVE. O MOTIVO É O VOLUME DE DISTRIBUIÇÃO: na sepse ele aumenta (capilar permeável, volume ressuscitado, albumina baixa), e a dose de ataque existe para compensar isso. Volume de distribuição não depende de depuração renal — então a dose de ataque é a mesma com creatinina alta, em anúria e em diálise. ⚠️ E O AJUSTE PRECOCE É O ERRO MAIS DOCUMENTADO AQUI: na coorte que comparou ajustar nas primeiras 24 h contra adiar, quem ADIOU teve MENOR mortalidade hospitalar (HR 0,588; IC 95% 0,355–0,974). Subdosar o séptico mata mais rápido que acumular a droga. ➜ O QUE SE AJUSTA É A MANUTENÇÃO — dose ou intervalo das doses seguintes —, e não antes de 24 a 48 h sem monitorização de nível. Até lá: DOSE A FUNÇÃO RENAL e registre, em vez de reduzir. ⚠️ A VANCOMICINA SEGUE OUTRO REGIME: ataque pelo PESO REAL e manutenção guiada por NÍVEL/AUC, não por calendário.":
    "⚠️ ESTA PRIMERA DOSIS DE BETALACTÁMICO NO SE AJUSTA POR FUNCIÓN RENAL — Y NO DEBE. EL MOTIVO ES EL VOLUMEN DE DISTRIBUCIÓN: en la sepsis aumenta (capilar permeable, volumen reanimado, albúmina baja), y la dosis de carga existe para compensarlo. El volumen de distribución no depende de la depuración renal — así que la dosis de carga es la misma con creatinina alta, en anuria y en diálisis. ⚠️ Y EL AJUSTE PRECOZ ES EL ERROR MÁS DOCUMENTADO AQUÍ: en la cohorte que comparó ajustar en las primeras 24 h contra retrasarlo, quienes RETRASARON tuvieron MENOR mortalidad hospitalaria (HR 0,588; IC 95% 0,355–0,974). Subdosificar al séptico mata más rápido que acumular el fármaco. ➜ LO QUE SE AJUSTA ES EL MANTENIMIENTO — dosis o intervalo de las dosis siguientes —, y no antes de 24 a 48 h sin monitorización de nivel. Hasta entonces: MIDA LA FUNCIÓN RENAL y regístrela, en vez de reducir. ⚠️ LA VANCOMICINA SIGUE OTRO RÉGIMEN: carga por PESO REAL y mantenimiento guiado por NIVEL/AUC, no por calendario.",
  "➜ PARA A MANUTENÇÃO, DO SEGUNDO DIA EM DIANTE: o app tem calculadora de dose por função renal em CALCULADORAS & ESCORES › \"Dose de antibiótico (TFG)\", e ela cobre VANCOMICINA, PIP-TAZO e MEROPENÉM — com as faixas de ClCr, a infusão estendida de 4 h do pip-tazo para Pseudomonas, o esquema de hemodiálise e o alvo de AUC/MIC da vancomicina. ⚠️ ELA PEDE O ClCr ABSOLUTO, NÃO A TFG INDEXADA por superfície corporal: no obeso e no muito magro os dois números divergem muito, e é o absoluto que dosa. ⚠️ E OS DEMAIS ANTIBIÓTICOS DESTE APP NÃO TÊM AJUSTE RENAL IMPLEMENTADO — ceftriaxona, cefepima, ertapeném, metronidazol, clindamicina e os outros saem daqui em dose fixa, e o ajuste deles é com a bula ou o farmacêutico clínico.":
    "➜ PARA EL MANTENIMIENTO, DEL SEGUNDO DÍA EN ADELANTE: la app tiene calculadora de dosis por función renal en CALCULADORAS Y PUNTAJES › \"Dosis de antibiótico (TFG)\", y cubre VANCOMICINA, PIP-TAZO y MEROPENEM — con las franjas de ClCr, la infusión extendida de 4 h del pip-tazo para Pseudomonas, el esquema de hemodiálisis y el objetivo de AUC/MIC de la vancomicina. ⚠️ ELLA PIDE EL ClCr ABSOLUTO, NO LA TFG INDEXADA por superficie corporal: en el obeso y en el muy delgado los dos números difieren mucho, y es el absoluto el que dosifica. ⚠️ Y LOS DEMÁS ANTIBIÓTICOS DE ESTA APP NO TIENEN AJUSTE RENAL IMPLEMENTADO — ceftriaxona, cefepima, ertapenem, metronidazol, clindamicina y los otros salen de aquí en dosis fija, y su ajuste es con la ficha técnica o el farmacéutico clínico.",
};

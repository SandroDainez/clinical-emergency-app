...
export const ES_INTOXICACOES: Record<string, string> = {
  ...
  "⚠️ PRALIDOXIMA (2-PAM) — A CONDUTA MAIS CONTROVERSA DESTE NÓ, E VOCÊ PRECISA SABER DISSO ANTES DE DECIDIR. Três posições, todas atuais: ➜ A DIRETRIZ BRASILEIRA (Conitec/MS 2018) RECOMENDA CONTRA o uso de oximas na intoxicação por inibidores de colinesterase — recomendação CONDICIONAL contra, evidência de qualidade MUITO BAIXA. Cinco ensaios randomizados não mostraram benefício em mortalidade, necessidade de ventilação ou síndrome intermediária, e há indícios de que possam ser prejudiciais no autoenvenenamento grave. ⚠️ E SÃO CONTRAINDICADAS NO CARBAMATO — nele a colinesterase se reativa sozinha, e não há o que reativar. ➜ A OMS MANTÉM a recomendação: 1 a 2 g IV no adulto, em cerca de 30 minutos. ⚠️ NUNCA EM BOLUS RÁPIDO — a infusão rápida associa-se a parada cardíaca e paralisia muscular. ➜ A META-ANÁLISE DE ENSAIOS RANDOMIZADOS não encontrou benefício em mortalidade, e o Reino Unido retirou a droga do arsenal.":
    "⚠️ PRALIDOXIMA (2-PAM) — LA CONDUCTA MÁS CONTROVERTIDA DE ESTE NODO, Y USTED NECESITA SABERLO ANTES DE DECIDIR. Tres posiciones, todas actuales: ➜ LA DIRECTRIZ BRASILEÑA (Conitec/MS 2018) RECOMIENDA EN CONTRA del uso de oximas en la intoxicación por inhibidores de colinesterasa — recomendación CONDICIONAL en contra, evidencia de calidad MUY BAJA. Cinco ensayos randomizados no mostraron beneficio en mortalidad, necesidad de ventilación ni síndrome intermedio, y hay indicios de que puedan ser perjudiciales en el autoenvenenamiento grave. ⚠️ Y ESTÁN CONTRAINDICADAS EN EL CARBAMATO — en él la colinesterasa se reactiva sola, y no hay qué reactivar. ➜ LA OMS MANTIENE la recomendación: 1 a 2 g IV en el adulto, en cerca de 30 minutos. ⚠️ NUNCA EN BOLO RÁPIDO — la infusión rápida se asocia a paro cardíaco y parálisis muscular. ➜ EL METAANÁLISIS DE ENSAYOS RANDOMIZADOS no encontró beneficio en mortalidad, y el Reino Unido retiró el fármaco del arsenal.",
  "➜ O QUE FAZER COM ISSO, NA PRÁTICA: a ATROPINA é o tratamento, e ela não depende desta decisão — comece por ela e não a atrase esperando oxima nenhuma. Se o protocolo do seu serviço prevê pralidoxima, dê no ORGANOFOSFORADO (não no carbamato) e QUANTO ANTES: o envelhecimento da enzima é rápido e varia conforme o composto, e depois dele não há mais o que reativar. ⚠️ A CINÉTICA POR COMPOSTO NÃO FOI VERIFICADA POR ESTE APP — não confie em nenhuma janela em horas que você tenha lido — inclusive a que ESTE TEXTO trazia antes, que não tinha fonte e dava falsa tranquilidade a quem deveria estar correndo.":
    "➜ QUÉ HACER CON ESTO, EN LA PRÁCTICA: la ATROPINA es el tratamiento, y no depende de esta decisión — comience por ella y no la retrase esperando ninguna oxima. Si el protocolo de su servicio prevé pralidoxima, adminístrela en el ORGANOFOSFORADO (no en el carbamato) y CUANTO ANTES: el envejecimiento de la enzima es rápido y varía según el compuesto, y después de él no hay más qué reactivar. ⚠️ LA CINÉTICA POR COMPUESTO NO FUE VERIFICADA POR ESTA APP — no confíe en ninguna ventana en horas que haya leído — incluida la que ESTE TEXTO traía antes, que no tenía fuente y daba falsa tranquilidad a quien debería estar corriendo.",
};

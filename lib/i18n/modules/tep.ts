...
export const ES_TEP: Record<string, string> = {
  ...
  "⚠️ Antes de pedir a AngioTC: gestação, função renal e alergia a contraste mudam o exame, e o escore não pergunta nenhuma das três. Na gestante, começar por doppler venoso de membros inferiores (se positivo, trata sem irradiar) e, se negativo, discutir cintilografia de perfusão ou AngioTC com protocolo de dose reduzida. Na injúria renal ou na alergia ao contraste, a cintilografia V/Q é a alternativa. Abrir o módulo TEP.": "⚠️ Antes de pedir la AngioTC: embarazo, función renal y alergia al contraste cambian el examen, y el puntaje no pregunta ninguna de las tres. En la embarazada, comenzar por doppler venoso de miembros inferiores (si es positivo, se trata sin irradiar) y, si es negativo, discutir gammagrafía de perfusión o AngioTC con protocolo de dosis reducida. En la injuria renal o en la alergia al contraste, la gammagrafía V/Q es la alternativa. Abrir el módulo TEP.",
  "Metas: SpO₂ ≥ 94% com suporte; HNF com TTPa 60–100 s; repetir troponina/BNP em 6–12 h da primeira dosagem.": "Metas: SpO₂ ≥ 94% con soporte; HNF con TTPa 60–100 s; repetir troponina/BNP a las 6–12 h de la primera determinación.",
  "TEP SUBSEGMENTAR ISOLADO TAMBÉM É TEP: anticoagule na maioria dos casos. Vigilância sem anticoagular só se baixo risco, com ultrassom de membros negativo e seguimento garantido.":
    "EL TEP SUBSEGMENTARIO AISLADO TAMBIÉN ES TEP: anticoagule en la mayoría de los casos. Vigilancia sin anticoagular solo si es de bajo riesgo, con ecografía de miembros negativa y seguimiento garantizado.",
  "O QUE O WELLS DECIDE É O PRÓXIMO EXAME, NÃO O DIAGNÓSTICO: ≤ 4 significa TEP improvável e o caminho é o D-dímero; > 4 significa TEP provável e o caminho é a angioTC DIRETO. ⚠️ COM WELLS > 4 NÃO SE PEDE D-DÍMERO — um resultado negativo ali não descarta, e o exame só adia a imagem.":
    "LO QUE EL WELLS DECIDE ES EL PRÓXIMO EXAMEN, NO EL DIAGNÓSTICO: ≤ 4 significa TEP improbable y el camino es el dímero D; > 4 significa TEP probable y el camino es la angioTC DIRECTO. ⚠️ CON WELLS > 4 NO SE PIDE DÍMERO D — un resultado negativo ahí no descarta, y el examen solo retrasa la imagen.",
  "⚠️ EM PCR OU COLAPSO IMINENTE, AS CONTRAINDICAÇÕES RELATIVAS TORNAM-SE ACEITÁVEIS — a conta inverte: o risco de sangrar perde para o risco de morrer nos próximos minutos. As absolutas continuam absolutas; a lista das duas está abaixo.":
    "⚠️ EN PCR O COLAPSO INMINENTE, LAS CONTRAINDICACIONES RELATIVAS SE VUELVEN ACEPTABLES — la cuenta se invierte: el riesgo de sangrar pierde ante el riesgo de morir en los próximos minutos. Las absolutas siguen siendo absolutas; la lista de ambas está abajo.",
  "⚠️ ACIMA DOS 50 ANOS O CORTE NÃO É 500 — É A IDADE VEZES 10 (ADJUST-PE): aos 70 anos, 700 ng/mL. Usar o corte fixo nesta faixa transforma em positivo quem já estava descartado, e manda para a angioTC quem não precisava.":
    "⚠️ POR ENCIMA DE LOS 50 AÑOS EL CORTE NO ES 500 — ES LA EDAD POR 10 (ADJUST-PE): a los 70 años, 700 ng/mL. Usar el corte fijo en esta franja convierte en positivo a quien ya estaba descartado, y manda a la angioTC a quien no lo necesitaba.",
  "OS TRÊS CRITÉRIOS QUE ABREM A PORTA DA ALTA (HOME-PE/Hestia): sPESI = 0, SEM disfunção de ventrículo direito ao ecocardiograma e troponina NORMAL. Os três juntos — falta um, o paciente interna. As condições clínicas e sociais estão abaixo.":
    "LOS TRES CRITERIOS QUE ABREN LA PUERTA DEL ALTA (HOME-PE/Hestia): sPESI = 0, SIN disfunción de ventrículo derecho en el ecocardiograma y troponina NORMAL. Los tres juntos — falta uno, el paciente ingresa. Las condiciones clínicas y sociales están abajo.",
  ...
  "Se houver indicação de anticoagulação e não houver contraindicação, iniciar anticoagulação terapêutica precocemente. AHA/ACC 2026: quando anticoagulação parenteral inicial for necessária nas categorias C1–E1, preferir HBPM à HNF; se a imagem estiver atrasada em suspeita C2 ou superior e o risco hemorrágico for baixo, anticoagulação terapêutica pode ser iniciada antes da confirmação. Não atrasar terapia avançada necessária por busca de imagem no colapso iminente.":
    "Si existe indicación de anticoagulación y no hay contraindicación, iniciar anticoagulación terapéutica precozmente. AHA/ACC 2026: cuando se necesite anticoagulación parenteral inicial en categorías C1–E1, preferir HBPM a HNF; si la imagen se retrasa en sospecha C2 o superior y el riesgo hemorrágico es bajo, puede iniciarse anticoagulación terapéutica antes de la confirmación. No retrasar una terapia avanzada necesaria buscando imagen ante colapso inminente.",
  "Emergência com risco de morte. Suporte hemodinâmico cauteloso + anticoagulação terapêutica quando indicada e não contraindicada.":
    "Emergencia con riesgo de muerte. Soporte hemodinámico cauteloso + anticoagulación terapéutica cuando esté indicada y no contraindicada.",
  ...
  "Após ROSC, NÃO complete automaticamente uma dose total de 100 mg apenas porque foi iniciado um esquema durante a parada: a estratégia ótima de fibrinólise na PCR não está estabelecida. Reavaliar sangramento, hemodinâmica, diagnóstico e necessidade de terapia adicional conforme protocolo/equipe especializada.":
    "Después del ROSC, NO completar automáticamente una dosis total de 100 mg solo porque se inició un esquema durante el paro: la estrategia óptima de fibrinólisis en PCR no está establecida. Reevaluar sangrado, hemodinamia, diagnóstico y necesidad de terapia adicional según protocolo/equipo especializado.",
  "DURAÇÃO DA RCP APÓS FIBRINÓLISE: ERC 2025 recomenda continuar RCP por pelo menos 60–90 min. AHA 2025 considera a duração ótima incerta; portanto registre o horário da fibrinólise e evite encerrar precocemente sem considerar essa diferença entre diretrizes e o contexto clínico.":
    "DURACIÓN DE LA RCP DESPUÉS DE FIBRINÓLISIS: ERC 2025 recomienda continuar la RCP durante al menos 60–90 min. AHA 2025 considera incierta la duración óptima; por lo tanto registre la hora de la fibrinólisis y evite terminar precozmente sin considerar esta diferencia entre guías y el contexto clínico.",
  ...
  "SEGUIMENTO PÓS-TEP: perguntar por dispneia e limitação funcional em TODAS as consultas por pelo menos 1 ano. Se sintomas persistirem após cerca de 3 meses de anticoagulação terapêutica, avaliar doença pulmonar tromboembólica crônica (CTEPD) e outras causas; não fazer imagem de controle rotineira apenas para documentar resolução em paciente assintomático de baixa suspeita.":
    "SEGUIMIENTO POST-TEP: preguntar por disnea y limitación funcional en TODAS las consultas durante al menos 1 año. Si persisten síntomas después de aproximadamente 3 meses de anticoagulación terapéutica, evaluar enfermedad pulmonar tromboembólica crónica (CTEPD) y otras causas; no realizar imagen de control rutinaria solo para documentar resolución en un paciente asintomático con baja sospecha.",
  "SUPORTE RESPIRATÓRIO: na hipoxemia moderada-grave, preferir cânula nasal de alto fluxo ao cateter nasal convencional. Evitar sedação profunda e ventilação mecânica salvo indicação clínica forte, porque indução e pressão positiva podem precipitar colapso do VD. Se intubação for inevitável, ter vasopressor/inotrópico e estratégia de resgate hemodinâmico imediatamente disponíveis.":
    "SOPORTE RESPIRATORIO: en hipoxemia moderada-grave, preferir cánula nasal de alto flujo frente a cánula nasal convencional. Evitar sedación profunda y ventilación mecánica salvo indicación clínica fuerte, porque la inducción y la presión positiva pueden precipitar colapso del VD. Si la intubación es inevitable, disponer de vasopresor/inotrópico y estrategia de rescate hemodinámico de inmediato.",
  ...
  "AHA/ACC 2026: em E1–E2, com risco hemorrágico aceitável e quando terapia avançada está sendo considerada, trombólise sistêmica + anticoagulação é razoável sobre anticoagulação isolada; em D1–D2 pode ser considerada para prevenir deterioração. Em C3 o benefício é incerto; em A1–C2 não usar trombólise sistêmica sobre anticoagulação devido ao maior risco de sangramento grave e hemorragia intracraniana.":
    "AHA/ACC 2026: en E1–E2, con riesgo hemorrágico aceptable y cuando se considera terapia avanzada, trombólisis sistémica + anticoagulación es razonable frente a anticoagulación sola; en D1–D2 puede considerarse para prevenir deterioro. En C3 el beneficio es incierto; en A1–C2 no usar trombólisis sistémica sobre anticoagulación por el mayor riesgo de sangrado grave y hemorragia intracraneal.",
  "AHA/ACC 2026: anticoagulação é a base do tratamento. Se elegível para via oral, preferir DOAC a antagonista da vitamina K; quando terapia parenteral inicial for necessária em C1–E1, preferir HBPM a HNF, salvo contraindicação/contexto específico.":
    "AHA/ACC 2026: la anticoagulación es la base del tratamiento. Si es elegible para vía oral, preferir DOAC frente a antagonista de vitamina K; cuando se requiera terapia parenteral inicial en C1–E1, preferir HBPM frente a HNF, salvo contraindicación/contexto específico.",

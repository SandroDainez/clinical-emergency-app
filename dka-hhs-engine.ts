...
function buildFields(a: Assessment): AuxiliaryPanel["fields"] {
  return [
    { id: "age", label: "Idade (anos)", value: a.age, keyboardType: "numeric", section: "Identificação do paciente" },
    {
      id: "sex",
      label: "Sexo",
      value: a.sex,
    ...
    { id: "allergies", label: "Alergias medicamentosas", value: a.allergies, fullWidth: true, section: "Identificação do paciente" },

    {
      ...
      presets: [
        { label: "DM1", value: "DM1" },
        { label: "DM2", value: "DM2" },
        { label: "Desconhecido / primeiro episódio", value: "Desconhecido / primeiro episódio" },
      ],
    },
    {
      id: "insulinUse",
    ...
    { id: "spo2", label: "SpO₂ (%)", value: a.spo2, keyboardType: "numeric", section: "Primeiros minutos — emergência" },
    {
      ...
      presets: [
        { label: "Ar ambiente", value: "Ar ambiente" },
        { label: "CN por cateter", value: "CN por cateter" },
        { label: "Máscara / Venturi", value: "Máscara / Venturi" },
        { label: "VM não invasiva", value: "VM não invasiva" },
      ],
    },
    {
      id: "ivAccess",
...

    {
      ...
      presetMode: "toggle_token",
      presets: [
        { label: "Poliúria / polidipsia", value: "Poliúria / polidipsia" },
        { label: "Náuseas / vômitos", value: "Náuseas / vômitos" },
        { label: "Dor abdominal", value: "Dor abdominal" },
        { label: "Dispneia / Kussmaul", value: "Dispneia / Kussmaul" },
        { label: "Alteração de consciência", value: "Alteração de consciência" },
      ],
    },
    { id: "heartRate", label: "FC (bpm)", value: a.heartRate, keyboardType: "numeric", section: "Sinais vitais" },
    { id: "systolicPressure", label: "PAS (mmHg)", value: a.systolicPressure, keyboardType: "numeric", section: "Sinais vitais" },
    { id: "diastolicPressure", label: "PAD (mmHg)", value: a.diastolicPressure, keyboardType: "numeric", section: "Sinais vitais" },
    { id: "respiratoryRate", label: "FR (irpm)", value: a.respiratoryRate, keyboardType: "numeric", section: "Sinais vitais" },
    { id: "temperature", label: "Temperatura (°C)", value: a.temperature, keyboardType: "numeric", section: "Sinais vitais" },
    { id: "gcs", label: "GCS", value: a.gcs, keyboardType: "numeric", section: "Sinais vitais" },
    {
      id: "examDehydration",
    ...
    { id: "glucose", label: "Glicemia (mg/dL)", value: a.glucose, keyboardType: "numeric", section: "Laboratório" },
    { id: "ph", label: "pH (venoso/arterial)", value: a.ph, keyboardType: "numeric", section: "Laboratório" },
    { id: "bicarb", label: "HCO₃⁻ (mEq/L)", value: a.bicarb, keyboardType: "numeric", section: "Laboratório" },
    { id: "sodium", label: "Na⁺ (mEq/L)", value: a.sodium, keyboardType: "numeric", section: "Laboratório" },
    { id: "chloride", label: "Cl⁻ (mEq/L)", value: a.chloride, keyboardType: "numeric", section: "Laboratório" },
    { id: "potassium", label: "K⁺ (mEq/L)", value: a.potassium, keyboardType: "numeric", section: "Laboratório" },
    { id: "creatinine", label: "Creatinina (mg/dL)", value: a.creatinine, keyboardType: "numeric", section: "Laboratório" },
    { id: "bun", label: "Ureia / BUN (mg/dL)", value: a.bun, keyboardType: "numeric", section: "Laboratório" },
    {
      id: "ketones",
    ...
    { id: "lactate", label: "Lactato (opcional)", value: a.lactate, keyboardType: "numeric", section: "Laboratório" },

    {
      ...
      presets: [
        ...
        { label: "Omissão insulina / bomba", value: "Omissão insulina / bomba" },
        { label: "IAM / SCA", value: "IAM / SCA" },
        { label: "Medicamento (corticoide, etc.)", value: "Medicamento (corticoide, etc.)" },
        { label: "Álcool / drogas", value: "Álcool / drogas" },
    ...
    },
    {
      ...
      presetMode: "toggle_token",
      presets: [
        { label: "SF 0,9% — bolus inicial conforme peso", value: "SF 0,9% — bolus inicial conforme peso" },
        { label: "Após expansão: considerar meio isotônico / GL 5% com insulina se hipoglicemia relativa", value: "GL 5% quando glicemia alvo na CAD" },
      ],
    },
    {
      id: "treatmentInsulin",
    ...
    },
    {
      ...
      presets: [
        { label: "UTI", value: "UTI" },
        { label: "Observação intensiva / intermediate", value: "Observação intensiva / intermediate" },
        { label: "Enfermaria (caso selecionado)", value: "Enfermaria (caso selecionado)" },
      ],
    },
    {
      id: "freeNotes",

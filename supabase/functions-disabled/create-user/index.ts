/**
 * STUB DE DEGRADAÇÃO · create-user — responde **503 e ⛔ nada mais**.
 *
 ...
 *
 * Reimplantar a partir de `supabase/functions/create-user/`, que
...
Deno.serve((req) => {
   ...
   */
  return new Response(
    JSON.stringify({ error: "service_unavailable", function: "create-user" }),
    {
      status: 503,

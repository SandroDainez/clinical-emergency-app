/**
 * STUB DE DEGRADAÇÃO · acls-assistant — responde **503 e ⛔ nada mais**.
 *
 ...
 *
 * Reimplantar a partir de `supabase/functions/acls-assistant/`, que
...
Deno.serve((req) => {
   ...
   */
  return new Response(
    JSON.stringify({ error: "service_unavailable", function: "acls-assistant" }),
    {
      status: 503,

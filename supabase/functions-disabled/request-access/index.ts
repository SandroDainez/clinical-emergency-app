/**
 * STUB DE DEGRADAÇÃO · request-access — responde **503 e ⛔ nada mais**.
 *
 ...
 * versões anteriores de `request-access` e `acls-assistant` são as **vulneráveis**
 ...
 *
 * Reimplantar a partir de `supabase/functions/request-access/`, que
...
Deno.serve((req) => {
   ...
   */
  return new Response(
    JSON.stringify({ error: "service_unavailable", function: "request-access" }),
    {
      status: 503,

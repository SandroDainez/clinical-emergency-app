/**
 * STUB DE DEGRADAÇÃO · claim-anonymous-sessions — responde **503 e ⛔ nada mais**.
 *
 ...
 * versões anteriores de `create-user` e `acls-assistant` são as **vulneráveis**
 ...
 *
 * Reimplantar a partir de `supabase/functions/claim-anonymous-sessions/`, que
...
Deno.serve((req) => {
   ...
   */
  return new Response(
    JSON.stringify({ error: "service_unavailable", function: "claim-anonymous-sessions" }),
    {
      status: 503,
